    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Creates a private CSV, stores it in Neon Object Storage, and adds it to the document vault for AI indexing.</CardDescription>
        </CardHeader>
        <CardContent className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {(["sales", "expenses", "inventory", "tasks"] as const).map(type => (
