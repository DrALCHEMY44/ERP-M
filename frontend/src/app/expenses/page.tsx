...
export default function ExpensesPage() {
  ...
  const handleSave = async (expenseData: Partial<Expense>) => {
    ...
    try {
      const selectedDate = expenseData.date ? new Date(`${expenseData.date}T12:00:00`) : new Date();
      if (Number.isNaN(selectedDate.getTime())) throw new Error("Invalid expense date");
      ...
      console.warn("Expense creation failed", e);
