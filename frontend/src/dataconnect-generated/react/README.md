...
- [**Queries**](#queries)
  ...
  - [*ListUsers*](#listusers)
  - [*ListLegacyAccessCodes*](#listlegacyaccesscodes)
  ...
  - [*listTasksAssignedToUser*](#listtasksassignedtouser)
...
- [**Mutations**](#mutations)
  ...
  - [*CreateMirrorOutbox*](#createmirroroutbox)
  - [*UpdateMirrorOutbox*](#updatemirroroutbox)
...
You can execute the `ListLegacyAccessCodes` Query using the following Query hook function, which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts):

```javascript
useListLegacyAccessCodes(dc: DataConnect, options?: useDataConnectQueryOptions<ListLegacyAccessCodesData>): UseDataConnectQueryResult<ListLegacyAccessCodesData, undefined>;
```
You can also pass in a `DataConnect` instance to the Query hook function.
```javascript
useListLegacyAccessCodes(options?: useDataConnectQueryOptions<ListLegacyAccessCodesData>): UseDataConnectQueryResult<ListLegacyAccessCodesData, undefined>;
```

### Variables
The `ListLegacyAccessCodes` Query has no variables.
### Return Type
Recall that calling the `ListLegacyAccessCodes` Query hook function returns a `UseQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `UseQueryResult.status` field. You can also check for pending / success / error status using the `UseQueryResult.isPending`, `UseQueryResult.isSuccess`, and `UseQueryResult.isError` fields.

To access the data returned by a Query, use the `UseQueryResult.data` field. The data for the `ListLegacyAccessCodes` Query is of type `ListLegacyAccessCodesData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `ListLegacyAccessCodes`'s Query hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig } from '@dataconnect/generated';
import { useListLegacyAccessCodes } from '@dataconnect/generated/react'

export default function ListLegacyAccessCodesComponent() {
  // You don't have to do anything to "execute" the Query.
  // Call the Query hook function to get a `UseQueryResult` object which holds the state of your Query.
  const query = useListLegacyAccessCodes();

  // You can also pass in a `DataConnect` instance to the Query hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const query = useListLegacyAccessCodes(dataConnect);

  // You can also pass in a `useDataConnectQueryOptions` object to the Query hook function.
  const options = { staleTime: 5 * 1000 };
  const query = useListLegacyAccessCodes(options);

  // You can also pass both a `DataConnect` instance and a `useDataConnectQueryOptions` object.
  const dataConnect = getDataConnect(connectorConfig);
  const options = { staleTime: 5 * 1000 };
  const query = useListLegacyAccessCodes(dataConnect, options);
...
## getBusinessById
You can execute the `getBusinessById` Query using the following Query hook function, which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts):
...
To access the data returned by a Query, use the `UseQueryResult.data` field. The data for the `getBusinessById` Query is of type `GetBusinessByIdData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
## getBusinessByCode
You can execute the `getBusinessByCode` Query using the following Query hook function, which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts):

```javascript
useGetBusinessByCode(dc: DataConnect, vars: GetBusinessByCodeVariables, options?: useDataConnectQueryOptions<GetBusinessByCodeData>): UseDataConnectQueryResult<GetBusinessByCodeData, GetBusinessByCodeVariables>;
```
You can also pass in a `DataConnect` instance to the Query hook function.
```javascript
useGetBusinessByCode(vars: GetBusinessByCodeVariables, options?: useDataConnectQueryOptions<GetBusinessByCodeData>): UseDataConnectQueryResult<GetBusinessByCodeData, GetBusinessByCodeVariables>;
```
...
```
### Return Type
Recall that calling the `getBusinessByCode` Query hook function returns a `UseQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `UseQueryResult.status` field. You can also check for pending / success / error status using the `UseQueryResult.isPending`, `UseQueryResult.isSuccess`, and `UseQueryResult.isError` fields.

To access the data returned by a Query, use the `UseQueryResult.data` field. The data for the `getBusinessByCode` Query is of type `GetBusinessByCodeData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `getBusinessByCode`'s Query hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, GetBusinessByCodeVariables } from '@dataconnect/generated';
import { useGetBusinessByCode } from '@dataconnect/generated/react'
...
export default function GetBusinessByCodeComponent() {
  ...
  // You don't have to do anything to "execute" the Query.
  // Call the Query hook function to get a `UseQueryResult` object which holds the state of your Query.
  const query = useGetBusinessByCode(getBusinessByCodeVars);
  // Variables can be defined inline as well.
  const query = useGetBusinessByCode({ code: ..., });

  // You can also pass in a `DataConnect` instance to the Query hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const query = useGetBusinessByCode(dataConnect, getBusinessByCodeVars);

  // You can also pass in a `useDataConnectQueryOptions` object to the Query hook function.
  const options = { staleTime: 5 * 1000 };
  const query = useGetBusinessByCode(getBusinessByCodeVars, options);

  // You can also pass both a `DataConnect` instance and a `useDataConnectQueryOptions` object.
  const dataConnect = getDataConnect(connectorConfig);
  const options = { staleTime: 5 * 1000 };
  const query = useGetBusinessByCode(dataConnect, getBusinessByCodeVars, options);
...
## getBusinessesByName
You can execute the `getBusinessesByName` Query using the following Query hook function, which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts):

```javascript
useGetBusinessesByName(dc: DataConnect, vars: GetBusinessesByNameVariables, options?: useDataConnectQueryOptions<GetBusinessesByNameData>): UseDataConnectQueryResult<GetBusinessesByNameData, GetBusinessesByNameVariables>;
```
You can also pass in a `DataConnect` instance to the Query hook function.
```javascript
useGetBusinessesByName(vars: GetBusinessesByNameVariables, options?: useDataConnectQueryOptions<GetBusinessesByNameData>): UseDataConnectQueryResult<GetBusinessesByNameData, GetBusinessesByNameVariables>;
```

### Variables
The `getBusinessesByName` Query requires an argument of type `GetBusinessesByNameVariables`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
...
```
### Return Type
Recall that calling the `getBusinessesByName` Query hook function returns a `UseQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `UseQueryResult.status` field. You can also check for pending / success / error status using the `UseQueryResult.isPending`, `UseQueryResult.isSuccess`, and `UseQueryResult.isError` fields.

To access the data returned by a Query, use the `UseQueryResult.data` field. The data for the `getBusinessesByName` Query is of type `GetBusinessesByNameData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `getBusinessesByName`'s Query hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, GetBusinessesByNameVariables } from '@dataconnect/generated';
import { useGetBusinessesByName } from '@dataconnect/generated/react'
...
export default function GetBusinessesByNameComponent() {
  ...
  // You don't have to do anything to "execute" the Query.
  // Call the Query hook function to get a `UseQueryResult` object which holds the state of your Query.
  const query = useGetBusinessesByName(getBusinessesByNameVars);
  // Variables can be defined inline as well.
  const query = useGetBusinessesByName({ name: ..., });

  // You can also pass in a `DataConnect` instance to the Query hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const query = useGetBusinessesByName(dataConnect, getBusinessesByNameVars);

  // You can also pass in a `useDataConnectQueryOptions` object to the Query hook function.
  const options = { staleTime: 5 * 1000 };
  const query = useGetBusinessesByName(getBusinessesByNameVars, options);

  // You can also pass both a `DataConnect` instance and a `useDataConnectQueryOptions` object.
  const dataConnect = getDataConnect(connectorConfig);
  const options = { staleTime: 5 * 1000 };
  const query = useGetBusinessesByName(dataConnect, getBusinessesByNameVars, options);
...
You can execute the `verifyEmployeeAccess` Query using the following Query hook function, which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts):

```javascript
useVerifyEmployeeAccess(dc: DataConnect, vars: VerifyEmployeeAccessVariables, options?: useDataConnectQueryOptions<VerifyEmployeeAccessData>): UseDataConnectQueryResult<VerifyEmployeeAccessData, VerifyEmployeeAccessVariables>;
```
You can also pass in a `DataConnect` instance to the Query hook function.
```javascript
useVerifyEmployeeAccess(vars: VerifyEmployeeAccessVariables, options?: useDataConnectQueryOptions<VerifyEmployeeAccessData>): UseDataConnectQueryResult<VerifyEmployeeAccessData, VerifyEmployeeAccessVariables>;
```

### Variables
The `verifyEmployeeAccess` Query requires an argument of type `VerifyEmployeeAccessVariables`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
...
```
### Return Type
Recall that calling the `verifyEmployeeAccess` Query hook function returns a `UseQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `UseQueryResult.status` field. You can also check for pending / success / error status using the `UseQueryResult.isPending`, `UseQueryResult.isSuccess`, and `UseQueryResult.isError` fields.

To access the data returned by a Query, use the `UseQueryResult.data` field. The data for the `verifyEmployeeAccess` Query is of type `VerifyEmployeeAccessData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `verifyEmployeeAccess`'s Query hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, VerifyEmployeeAccessVariables } from '@dataconnect/generated';
import { useVerifyEmployeeAccess } from '@dataconnect/generated/react'
...
export default function VerifyEmployeeAccessComponent() {
  ...
  // You don't have to do anything to "execute" the Query.
  // Call the Query hook function to get a `UseQueryResult` object which holds the state of your Query.
  const query = useVerifyEmployeeAccess(verifyEmployeeAccessVars);
  // Variables can be defined inline as well.
  const query = useVerifyEmployeeAccess({ fullName: ..., role: ..., accessCodeHash: ..., tenantId: ..., businessId: ..., });

  // You can also pass in a `DataConnect` instance to the Query hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const query = useVerifyEmployeeAccess(dataConnect, verifyEmployeeAccessVars);

  // You can also pass in a `useDataConnectQueryOptions` object to the Query hook function.
  const options = { staleTime: 5 * 1000 };
  const query = useVerifyEmployeeAccess(verifyEmployeeAccessVars, options);

  // You can also pass both a `DataConnect` instance and a `useDataConnectQueryOptions` object.
  const dataConnect = getDataConnect(connectorConfig);
  const options = { staleTime: 5 * 1000 };
  const query = useVerifyEmployeeAccess(dataConnect, verifyEmployeeAccessVars, options);
...
## verifyUserLogin
You can execute the `verifyUserLogin` Query using the following Query hook function, which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts):

```javascript
useVerifyUserLogin(dc: DataConnect, vars: VerifyUserLoginVariables, options?: useDataConnectQueryOptions<VerifyUserLoginData>): UseDataConnectQueryResult<VerifyUserLoginData, VerifyUserLoginVariables>;
```
You can also pass in a `DataConnect` instance to the Query hook function.
```javascript
useVerifyUserLogin(vars: VerifyUserLoginVariables, options?: useDataConnectQueryOptions<VerifyUserLoginData>): UseDataConnectQueryResult<VerifyUserLoginData, VerifyUserLoginVariables>;
```
...
```
### Return Type
Recall that calling the `verifyUserLogin` Query hook function returns a `UseQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `UseQueryResult.status` field. You can also check for pending / success / error status using the `UseQueryResult.isPending`, `UseQueryResult.isSuccess`, and `UseQueryResult.isError` fields.

To access the data returned by a Query, use the `UseQueryResult.data` field. The data for the `verifyUserLogin` Query is of type `VerifyUserLoginData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `verifyUserLogin`'s Query hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, VerifyUserLoginVariables } from '@dataconnect/generated';
import { useVerifyUserLogin } from '@dataconnect/generated/react'
...
export default function VerifyUserLoginComponent() {
  ...
  // You don't have to do anything to "execute" the Query.
  // Call the Query hook function to get a `UseQueryResult` object which holds the state of your Query.
  const query = useVerifyUserLogin(verifyUserLoginVars);
  // Variables can be defined inline as well.
  const query = useVerifyUserLogin({ email: ..., fullName: ..., role: ..., accessCodeHash: ..., tenantId: ..., businessId: ..., });

  // You can also pass in a `DataConnect` instance to the Query hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const query = useVerifyUserLogin(dataConnect, verifyUserLoginVars);

  // You can also pass in a `useDataConnectQueryOptions` object to the Query hook function.
  const options = { staleTime: 5 * 1000 };
  const query = useVerifyUserLogin(verifyUserLoginVars, options);

  // You can also pass both a `DataConnect` instance and a `useDataConnectQueryOptions` object.
  const dataConnect = getDataConnect(connectorConfig);
  const options = { staleTime: 5 * 1000 };
  const query = useVerifyUserLogin(dataConnect, verifyUserLoginVars, options);
...
You can execute the `listTasksAssignedToUser` Query using the following Query hook function, which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts):

```javascript
useListTasksAssignedToUser(dc: DataConnect, vars: ListTasksAssignedToUserVariables, options?: useDataConnectQueryOptions<ListTasksAssignedToUserData>): UseDataConnectQueryResult<ListTasksAssignedToUserData, ListTasksAssignedToUserVariables>;
```
You can also pass in a `DataConnect` instance to the Query hook function.
```javascript
useListTasksAssignedToUser(vars: ListTasksAssignedToUserVariables, options?: useDataConnectQueryOptions<ListTasksAssignedToUserData>): UseDataConnectQueryResult<ListTasksAssignedToUserData, ListTasksAssignedToUserVariables>;
```

### Variables
The `listTasksAssignedToUser` Query requires an argument of type `ListTasksAssignedToUserVariables`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
...
```
### Return Type
Recall that calling the `listTasksAssignedToUser` Query hook function returns a `UseQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `UseQueryResult.status` field. You can also check for pending / success / error status using the `UseQueryResult.isPending`, `UseQueryResult.isSuccess`, and `UseQueryResult.isError` fields.

To access the data returned by a Query, use the `UseQueryResult.data` field. The data for the `listTasksAssignedToUser` Query is of type `ListTasksAssignedToUserData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `listTasksAssignedToUser`'s Query hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, ListTasksAssignedToUserVariables } from '@dataconnect/generated';
import { useListTasksAssignedToUser } from '@dataconnect/generated/react'
...
export default function ListTasksAssignedToUserComponent() {
  ...
  // You don't have to do anything to "execute" the Query.
  // Call the Query hook function to get a `UseQueryResult` object which holds the state of your Query.
  const query = useListTasksAssignedToUser(listTasksAssignedToUserVars);
  // Variables can be defined inline as well.
  const query = useListTasksAssignedToUser({ tenantId: ..., businessId: ..., userId: ..., });

  // You can also pass in a `DataConnect` instance to the Query hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const query = useListTasksAssignedToUser(dataConnect, listTasksAssignedToUserVars);

  // You can also pass in a `useDataConnectQueryOptions` object to the Query hook function.
  const options = { staleTime: 5 * 1000 };
  const query = useListTasksAssignedToUser(listTasksAssignedToUserVars, options);

  // You can also pass both a `DataConnect` instance and a `useDataConnectQueryOptions` object.
  const dataConnect = getDataConnect(connectorConfig);
  const options = { staleTime: 5 * 1000 };
  const query = useListTasksAssignedToUser(dataConnect, listTasksAssignedToUserVars, options);
...
```javascript
useListNotifications(dc: DataConnect, vars: ListNotificationsVariables, options?: useDataConnectQueryOptions<ListNotificationsData>): UseDataConnectQueryResult<ListNotificationsData, ListNotificationsVariables>;
```
You can also pass in a `DataConnect` instance to the Query hook function.
```javascript
useListNotifications(vars: ListNotificationsVariables, options?: useDataConnectQueryOptions<ListNotificationsData>): UseDataConnectQueryResult<ListNotificationsData, ListNotificationsVariables>;
```
...
```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, ListNotificationsVariables } from '@dataconnect/generated';
...
export default function ListNotificationsComponent() {
  ...
  // You don't have to do anything to "execute" the Query.
  // Call the Query hook function to get a `UseQueryResult` object which holds the state of your Query.
  const query = useListNotifications(listNotificationsVars);
  // Variables can be defined inline as well.
  const query = useListNotifications({ tenantId: ..., businessId: ..., userId: ..., });

  // You can also pass in a `DataConnect` instance to the Query hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const query = useListNotifications(dataConnect, listNotificationsVars);

  // You can also pass in a `useDataConnectQueryOptions` object to the Query hook function.
  const options = { staleTime: 5 * 1000 };
  const query = useListNotifications(listNotificationsVars, options);

  // You can also pass both a `DataConnect` instance and a `useDataConnectQueryOptions` object.
  const dataConnect = getDataConnect(connectorConfig);
  const options = { staleTime: 5 * 1000 };
  const query = useListNotifications(dataConnect, listNotificationsVars, options);
...
You can execute the `ListPendingMirrorOutbox` Query using the following Query hook function, which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts):

```javascript
useListPendingMirrorOutbox(dc: DataConnect, options?: useDataConnectQueryOptions<ListPendingMirrorOutboxData>): UseDataConnectQueryResult<ListPendingMirrorOutboxData, undefined>;
```
You can also pass in a `DataConnect` instance to the Query hook function.
```javascript
useListPendingMirrorOutbox(options?: useDataConnectQueryOptions<ListPendingMirrorOutboxData>): UseDataConnectQueryResult<ListPendingMirrorOutboxData, undefined>;
```

### Variables
The `ListPendingMirrorOutbox` Query has no variables.
### Return Type
Recall that calling the `ListPendingMirrorOutbox` Query hook function returns a `UseQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `UseQueryResult.status` field. You can also check for pending / success / error status using the `UseQueryResult.isPending`, `UseQueryResult.isSuccess`, and `UseQueryResult.isError` fields.

To access the data returned by a Query, use the `UseQueryResult.data` field. The data for the `ListPendingMirrorOutbox` Query is of type `ListPendingMirrorOutboxData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `ListPendingMirrorOutbox`'s Query hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig } from '@dataconnect/generated';
import { useListPendingMirrorOutbox } from '@dataconnect/generated/react'

export default function ListPendingMirrorOutboxComponent() {
  // You don't have to do anything to "execute" the Query.
  // Call the Query hook function to get a `UseQueryResult` object which holds the state of your Query.
  const query = useListPendingMirrorOutbox();

  // You can also pass in a `DataConnect` instance to the Query hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const query = useListPendingMirrorOutbox(dataConnect);

  // You can also pass in a `useDataConnectQueryOptions` object to the Query hook function.
  const options = { staleTime: 5 * 1000 };
  const query = useListPendingMirrorOutbox(options);

  // You can also pass both a `DataConnect` instance and a `useDataConnectQueryOptions` object.
  const dataConnect = getDataConnect(connectorConfig);
  const options = { staleTime: 5 * 1000 };
  const query = useListPendingMirrorOutbox(dataConnect, options);
  ...
  // If the Query is successful, you can access the data returned using the `UseQueryResult.data` field.
  if (query.isSuccess) {
    console.log(query.data.mirrorOutboxes);
  }
  return <div>Query execution {query.isSuccess ? 'successful' : 'failed'}!</div>;
}
```
...
export default function CreateUserComponent() {
  ...
  const createUserVars: CreateUserVariables = {
    ...
    accessCodeHash: ..., // optional
  };
  mutation.mutate(createUserVars);
  // Variables can be defined inline as well.
  mutation.mutate({ id: ..., tenantId: ..., businessId: ..., email: ..., role: ..., fullName: ..., department: ..., phoneNumber: ..., accessCodeHash: ..., });
...
You can execute the `ClearLegacyAccessCode` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts)):
```javascript
useClearLegacyAccessCode(options?: useDataConnectMutationOptions<ClearLegacyAccessCodeData, FirebaseError, ClearLegacyAccessCodeVariables>): UseDataConnectMutationResult<ClearLegacyAccessCodeData, ClearLegacyAccessCodeVariables>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useClearLegacyAccessCode(dc: DataConnect, options?: useDataConnectMutationOptions<ClearLegacyAccessCodeData, FirebaseError, ClearLegacyAccessCodeVariables>): UseDataConnectMutationResult<ClearLegacyAccessCodeData, ClearLegacyAccessCodeVariables>;
```

### Variables
The `ClearLegacyAccessCode` Mutation requires an argument of type `ClearLegacyAccessCodeVariables`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
...
```
### Return Type
Recall that calling the `ClearLegacyAccessCode` Mutation hook function returns a `UseMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `UseMutationResult.status` field. You can also check for pending / success / error status using the `UseMutationResult.isPending`, `UseMutationResult.isSuccess`, and `UseMutationResult.isError` fields.

To execute the Mutation, call `UseMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation.

To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `ClearLegacyAccessCode` Mutation is of type `ClearLegacyAccessCodeData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `ClearLegacyAccessCode`'s Mutation hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, ClearLegacyAccessCodeVariables } from '@dataconnect/generated';
import { useClearLegacyAccessCode } from '@dataconnect/generated/react'

export default function ClearLegacyAccessCodeComponent() {
  // Call the Mutation hook function to get a `UseMutationResult` object which holds the state of your Mutation.
  const mutation = useClearLegacyAccessCode();

  // You can also pass in a `DataConnect` instance to the Mutation hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const mutation = useClearLegacyAccessCode(dataConnect);

  // You can also pass in a `useDataConnectMutationOptions` object to the Mutation hook function.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  const mutation = useClearLegacyAccessCode(options);
  ...
  const mutation = useClearLegacyAccessCode(dataConnect, options);
  ...
  mutation.mutate(clearLegacyAccessCodeVars, options);
...
export default function CreateBusinessComponent() {
  ...
  // Variables can be defined inline as well.
  mutation.mutate({ tenantId: ..., name: ..., location: ..., businessType: ..., region: ..., code: ..., });
...
You can execute the `ProvisionEmployeeUser` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts)):
```javascript
useProvisionEmployeeUser(options?: useDataConnectMutationOptions<ProvisionEmployeeUserData, FirebaseError, ProvisionEmployeeUserVariables>): UseDataConnectMutationResult<ProvisionEmployeeUserData, ProvisionEmployeeUserVariables>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useProvisionEmployeeUser(dc: DataConnect, options?: useDataConnectMutationOptions<ProvisionEmployeeUserData, FirebaseError, ProvisionEmployeeUserVariables>): UseDataConnectMutationResult<ProvisionEmployeeUserData, ProvisionEmployeeUserVariables>;
```

### Variables
The `ProvisionEmployeeUser` Mutation requires an argument of type `ProvisionEmployeeUserVariables`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
...
```
### Return Type
Recall that calling the `ProvisionEmployeeUser` Mutation hook function returns a `UseMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `UseMutationResult.status` field. You can also check for pending / success / error status using the `UseMutationResult.isPending`, `UseMutationResult.isSuccess`, and `UseMutationResult.isError` fields.

To execute the Mutation, call `UseMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation.

To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `ProvisionEmployeeUser` Mutation is of type `ProvisionEmployeeUserData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `ProvisionEmployeeUser`'s Mutation hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, ProvisionEmployeeUserVariables } from '@dataconnect/generated';
import { useProvisionEmployeeUser } from '@dataconnect/generated/react'

export default function ProvisionEmployeeUserComponent() {
  // Call the Mutation hook function to get a `UseMutationResult` object which holds the state of your Mutation.
  const mutation = useProvisionEmployeeUser();

  // You can also pass in a `DataConnect` instance to the Mutation hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const mutation = useProvisionEmployeeUser(dataConnect);

  // You can also pass in a `useDataConnectMutationOptions` object to the Mutation hook function.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  const mutation = useProvisionEmployeeUser(options);
  ...
  const mutation = useProvisionEmployeeUser(dataConnect, options);
  ...
  // Variables can be defined inline as well.
  mutation.mutate({ tenantId: ..., businessId: ..., email: ..., role: ..., fullName: ..., department: ..., phoneNumber: ..., accessCodeHash: ..., });

  // You can also pass in a `useDataConnectMutationOptions` object to `UseMutationResult.mutate()`.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  mutation.mutate(provisionEmployeeUserVars, options);
...
You can execute the `CompleteAssignedTask` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts)):
```javascript
useCompleteAssignedTask(options?: useDataConnectMutationOptions<CompleteAssignedTaskData, FirebaseError, CompleteAssignedTaskVariables>): UseDataConnectMutationResult<CompleteAssignedTaskData, CompleteAssignedTaskVariables>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useCompleteAssignedTask(dc: DataConnect, options?: useDataConnectMutationOptions<CompleteAssignedTaskData, FirebaseError, CompleteAssignedTaskVariables>): UseDataConnectMutationResult<CompleteAssignedTaskData, CompleteAssignedTaskVariables>;
```

### Variables
The `CompleteAssignedTask` Mutation requires an argument of type `CompleteAssignedTaskVariables`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
...
```
### Return Type
Recall that calling the `CompleteAssignedTask` Mutation hook function returns a `UseMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `UseMutationResult.status` field. You can also check for pending / success / error status using the `UseMutationResult.isPending`, `UseMutationResult.isSuccess`, and `UseMutationResult.isError` fields.

To execute the Mutation, call `UseMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation.

To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `CompleteAssignedTask` Mutation is of type `CompleteAssignedTaskData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `CompleteAssignedTask`'s Mutation hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, CompleteAssignedTaskVariables } from '@dataconnect/generated';
import { useCompleteAssignedTask } from '@dataconnect/generated/react'

export default function CompleteAssignedTaskComponent() {
  // Call the Mutation hook function to get a `UseMutationResult` object which holds the state of your Mutation.
  const mutation = useCompleteAssignedTask();

  // You can also pass in a `DataConnect` instance to the Mutation hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const mutation = useCompleteAssignedTask(dataConnect);

  // You can also pass in a `useDataConnectMutationOptions` object to the Mutation hook function.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  const mutation = useCompleteAssignedTask(options);
  ...
  const mutation = useCompleteAssignedTask(dataConnect, options);
  ...
  mutation.mutate(completeAssignedTaskVars, options);
...
## CreateMirrorOutbox
You can execute the `CreateMirrorOutbox` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts)):
```javascript
useCreateMirrorOutbox(options?: useDataConnectMutationOptions<CreateMirrorOutboxData, FirebaseError, CreateMirrorOutboxVariables>): UseDataConnectMutationResult<CreateMirrorOutboxData, CreateMirrorOutboxVariables>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useCreateMirrorOutbox(dc: DataConnect, options?: useDataConnectMutationOptions<CreateMirrorOutboxData, FirebaseError, CreateMirrorOutboxVariables>): UseDataConnectMutationResult<CreateMirrorOutboxData, CreateMirrorOutboxVariables>;
```

### Variables
The `CreateMirrorOutbox` Mutation requires an argument of type `CreateMirrorOutboxVariables`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
...
```
### Return Type
Recall that calling the `CreateMirrorOutbox` Mutation hook function returns a `UseMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `UseMutationResult.status` field. You can also check for pending / success / error status using the `UseMutationResult.isPending`, `UseMutationResult.isSuccess`, and `UseMutationResult.isError` fields.

To execute the Mutation, call `UseMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation.

To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `CreateMirrorOutbox` Mutation is of type `CreateMirrorOutboxData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `CreateMirrorOutbox`'s Mutation hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, CreateMirrorOutboxVariables } from '@dataconnect/generated';
import { useCreateMirrorOutbox } from '@dataconnect/generated/react'

export default function CreateMirrorOutboxComponent() {
  // Call the Mutation hook function to get a `UseMutationResult` object which holds the state of your Mutation.
  const mutation = useCreateMirrorOutbox();

  // You can also pass in a `DataConnect` instance to the Mutation hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const mutation = useCreateMirrorOutbox(dataConnect);

  // You can also pass in a `useDataConnectMutationOptions` object to the Mutation hook function.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  const mutation = useCreateMirrorOutbox(options);
  ...
  const mutation = useCreateMirrorOutbox(dataConnect, options);
  ...
  // Variables can be defined inline as well.
  mutation.mutate({ tenantId: ..., businessId: ..., entityType: ..., operation: ..., recordId: ..., payload: ..., });

  // You can also pass in a `useDataConnectMutationOptions` object to `UseMutationResult.mutate()`.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  mutation.mutate(createMirrorOutboxVars, options);
  ...
  // If the Mutation is successful, you can access the data returned using the `UseMutationResult.data` field.
  if (mutation.isSuccess) {
    console.log(mutation.data.mirrorOutbox_insert);
  }
  return <div>Mutation execution {mutation.isSuccess ? 'successful' : 'failed'}!</div>;
}
```
...
## UpdateMirrorOutbox
You can execute the `UpdateMirrorOutbox` Mutation using the `UseMutationResult` object returned by the following Mutation hook function (which is defined in [dataconnect-generated/react/index.d.ts](./index.d.ts)):
```javascript
useUpdateMirrorOutbox(options?: useDataConnectMutationOptions<UpdateMirrorOutboxData, FirebaseError, UpdateMirrorOutboxVariables>): UseDataConnectMutationResult<UpdateMirrorOutboxData, UpdateMirrorOutboxVariables>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useUpdateMirrorOutbox(dc: DataConnect, options?: useDataConnectMutationOptions<UpdateMirrorOutboxData, FirebaseError, UpdateMirrorOutboxVariables>): UseDataConnectMutationResult<UpdateMirrorOutboxData, UpdateMirrorOutboxVariables>;
```

### Variables
The `UpdateMirrorOutbox` Mutation requires an argument of type `UpdateMirrorOutboxVariables`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
...
```
### Return Type
Recall that calling the `UpdateMirrorOutbox` Mutation hook function returns a `UseMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `UseMutationResult.status` field. You can also check for pending / success / error status using the `UseMutationResult.isPending`, `UseMutationResult.isSuccess`, and `UseMutationResult.isError` fields.

To execute the Mutation, call `UseMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation.

To access the data returned by a Mutation, use the `UseMutationResult.data` field. The data for the `UpdateMirrorOutbox` Mutation is of type `UpdateMirrorOutboxData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `UpdateMirrorOutbox`'s Mutation hook function

```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, UpdateMirrorOutboxVariables } from '@dataconnect/generated';
import { useUpdateMirrorOutbox } from '@dataconnect/generated/react'

export default function UpdateMirrorOutboxComponent() {
  // Call the Mutation hook function to get a `UseMutationResult` object which holds the state of your Mutation.
  const mutation = useUpdateMirrorOutbox();

  // You can also pass in a `DataConnect` instance to the Mutation hook function.
  const dataConnect = getDataConnect(connectorConfig);
  const mutation = useUpdateMirrorOutbox(dataConnect);

  // You can also pass in a `useDataConnectMutationOptions` object to the Mutation hook function.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  const mutation = useUpdateMirrorOutbox(options);
  ...
  const mutation = useUpdateMirrorOutbox(dataConnect, options);
  ...
  mutation.mutate(updateMirrorOutboxVars);
  // Variables can be defined inline as well.
  mutation.mutate({ id: ..., status: ..., attempts: ..., nextAttemptAt: ..., lastError: ..., deliveredAt: ..., });

  // You can also pass in a `useDataConnectMutationOptions` object to `UseMutationResult.mutate()`.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  mutation.mutate(updateMirrorOutboxVars, options);
  ...
  // If the Mutation is successful, you can access the data returned using the `UseMutationResult.data` field.
  if (mutation.isSuccess) {
    console.log(mutation.data.mirrorOutbox_update);
  }
  return <div>Mutation execution {mutation.isSuccess ? 'successful' : 'failed'}!</div>;
}
```
