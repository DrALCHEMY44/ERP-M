import { BootstrapWorkspaceData, BootstrapWorkspaceVariables, CreateTenantData, CreateTenantVariables, UpdateTenantData, UpdateTenantVariables, DeleteTenantData, DeleteTenantVariables, CreateUserData, CreateUserVariables, UpdateUserData, UpdateUserVariables, DeleteUserData, DeleteUserVariables, ClearLegacyAccessCodeData, ClearLegacyAccessCodeVariables, CreateBusinessData, CreateBusinessVariables, UpdateBusinessData, UpdateBusinessVariables, UpsertBusinessSettingsData, UpsertBusinessSettingsVariables, DeleteBusinessData, DeleteBusinessVariables, ProvisionEmployeeUserData, ProvisionEmployeeUserVariables, CompleteAssignedTaskData, CompleteAssignedTaskVariables, CreateProductData, CreateProductVariables, UpdateProductData, UpdateProductVariables, DeleteProductData, DeleteProductVariables, CreateTransactionData, CreateTransactionVariables, UpdateTransactionData, UpdateTransactionVariables, DeleteTransactionData, DeleteTransactionVariables, CreateTaskCommentData, CreateTaskCommentVariables, UpdateTaskCommentData, UpdateTaskCommentVariables, DeleteTaskCommentData, DeleteTaskCommentVariables, CreateEmployeeWithAccessData, CreateEmployeeWithAccessVariables, UpdateEmployeeWithAccessData, UpdateEmployeeWithAccessVariables, DeleteEmployeeWithAccessData, DeleteEmployeeWithAccessVariables, CreateEmployeeData, CreateEmployeeVariables, UpdateEmployeeData, UpdateEmployeeVariables, DeleteEmployeeData, DeleteEmployeeVariables, CreateCustomerData, CreateCustomerVariables, UpdateCustomerData, UpdateCustomerVariables, DeleteCustomerData, DeleteCustomerVariables, CreateSupplierData, CreateSupplierVariables, UpdateSupplierData, UpdateSupplierVariables, DeleteSupplierData, DeleteSupplierVariables, CreateDocumentData, CreateDocumentVariables, UpdateDocumentData, UpdateDocumentVariables, DeleteDocumentData, DeleteDocumentVariables, CreateActivityLogData, CreateActivityLogVariables, CreateAiQueryData, CreateAiQueryVariables, UpdateAiQueryData, UpdateAiQueryVariables, DeleteAiQueryData, DeleteAiQueryVariables, CreateNotificationData, CreateNotificationVariables, UpdateNotificationData, UpdateNotificationVariables, DeleteNotificationData, DeleteNotificationVariables, CreateTaskData, CreateTaskVariables, UpdateTaskData, UpdateTaskVariables, DeleteTaskData, DeleteTaskVariables, CreateMirrorOutboxData, CreateMirrorOutboxVariables, UpdateMirrorOutboxData, UpdateMirrorOutboxVariables, ListTenantsData, ListUsersData, ListLegacyAccessCodesData, ListBusinessesData, ListBusinessesVariables, GetUserByEmailData, GetUserByEmailVariables, GetBusinessByIdData, GetBusinessByIdVariables, GetBusinessSettingsData, GetBusinessSettingsVariables, GetBusinessByCodeData, GetBusinessByCodeVariables, GetBusinessesByNameData, GetBusinessesByNameVariables, VerifyEmployeeAccessData, VerifyEmployeeAccessVariables, VerifyUserLoginData, VerifyUserLoginVariables, ListProductsByBusinessData, ListProductsByBusinessVariables, ListCustomersByBusinessData, ListCustomersByBusinessVariables, GetCustomerForCompanyData, GetCustomerForCompanyVariables, ListSaleCustomersByBusinessData, ListSaleCustomersByBusinessVariables, ListTaskAssigneesByBusinessData, ListTaskAssigneesByBusinessVariables, ListUsersByBusinessData, ListUsersByBusinessVariables, ListSuppliersByBusinessData, ListSuppliersByBusinessVariables, ListTasksByBusinessData, ListTasksByBusinessVariables, ListTasksAssignedToUserData, ListTasksAssignedToUserVariables, ListTransactionsByBusinessData, ListTransactionsByBusinessVariables, ListTransactionsByTypeData, ListTransactionsByTypeVariables, ListEmployeesByBusinessData, ListEmployeesByBusinessVariables, ListDocumentsByBusinessData, ListDocumentsByBusinessVariables, ListActivityLogsByUserData, ListActivityLogsByUserVariables, ListActivityLogsByBusinessData, ListActivityLogsByBusinessVariables, GetUserByIdData, GetUserByIdVariables, ListNotificationsData, ListNotificationsVariables, ListPendingMirrorOutboxData } from '../';
...
export function useClearLegacyAccessCode(options?: useDataConnectMutationOptions<ClearLegacyAccessCodeData, FirebaseError, ClearLegacyAccessCodeVariables>): UseDataConnectMutationResult<ClearLegacyAccessCodeData, ClearLegacyAccessCodeVariables>;
export function useClearLegacyAccessCode(dc: DataConnect, options?: useDataConnectMutationOptions<ClearLegacyAccessCodeData, FirebaseError, ClearLegacyAccessCodeVariables>): UseDataConnectMutationResult<ClearLegacyAccessCodeData, ClearLegacyAccessCodeVariables>;
...
export function useUpsertBusinessSettings(options?: useDataConnectMutationOptions<UpsertBusinessSettingsData, FirebaseError, UpsertBusinessSettingsVariables>): UseDataConnectMutationResult<UpsertBusinessSettingsData, UpsertBusinessSettingsVariables>;
export function useUpsertBusinessSettings(dc: DataConnect, options?: useDataConnectMutationOptions<UpsertBusinessSettingsData, FirebaseError, UpsertBusinessSettingsVariables>): UseDataConnectMutationResult<UpsertBusinessSettingsData, UpsertBusinessSettingsVariables>;
...
export function useProvisionEmployeeUser(options?: useDataConnectMutationOptions<ProvisionEmployeeUserData, FirebaseError, ProvisionEmployeeUserVariables>): UseDataConnectMutationResult<ProvisionEmployeeUserData, ProvisionEmployeeUserVariables>;
export function useProvisionEmployeeUser(dc: DataConnect, options?: useDataConnectMutationOptions<ProvisionEmployeeUserData, FirebaseError, ProvisionEmployeeUserVariables>): UseDataConnectMutationResult<ProvisionEmployeeUserData, ProvisionEmployeeUserVariables>;

export function useCompleteAssignedTask(options?: useDataConnectMutationOptions<CompleteAssignedTaskData, FirebaseError, CompleteAssignedTaskVariables>): UseDataConnectMutationResult<CompleteAssignedTaskData, CompleteAssignedTaskVariables>;
export function useCompleteAssignedTask(dc: DataConnect, options?: useDataConnectMutationOptions<CompleteAssignedTaskData, FirebaseError, CompleteAssignedTaskVariables>): UseDataConnectMutationResult<CompleteAssignedTaskData, CompleteAssignedTaskVariables>;
...
export function useCreateEmployeeWithAccess(options?: useDataConnectMutationOptions<CreateEmployeeWithAccessData, FirebaseError, CreateEmployeeWithAccessVariables>): UseDataConnectMutationResult<CreateEmployeeWithAccessData, CreateEmployeeWithAccessVariables>;
export function useCreateEmployeeWithAccess(dc: DataConnect, options?: useDataConnectMutationOptions<CreateEmployeeWithAccessData, FirebaseError, CreateEmployeeWithAccessVariables>): UseDataConnectMutationResult<CreateEmployeeWithAccessData, CreateEmployeeWithAccessVariables>;

export function useUpdateEmployeeWithAccess(options?: useDataConnectMutationOptions<UpdateEmployeeWithAccessData, FirebaseError, UpdateEmployeeWithAccessVariables>): UseDataConnectMutationResult<UpdateEmployeeWithAccessData, UpdateEmployeeWithAccessVariables>;
export function useUpdateEmployeeWithAccess(dc: DataConnect, options?: useDataConnectMutationOptions<UpdateEmployeeWithAccessData, FirebaseError, UpdateEmployeeWithAccessVariables>): UseDataConnectMutationResult<UpdateEmployeeWithAccessData, UpdateEmployeeWithAccessVariables>;

export function useDeleteEmployeeWithAccess(options?: useDataConnectMutationOptions<DeleteEmployeeWithAccessData, FirebaseError, DeleteEmployeeWithAccessVariables>): UseDataConnectMutationResult<DeleteEmployeeWithAccessData, DeleteEmployeeWithAccessVariables>;
export function useDeleteEmployeeWithAccess(dc: DataConnect, options?: useDataConnectMutationOptions<DeleteEmployeeWithAccessData, FirebaseError, DeleteEmployeeWithAccessVariables>): UseDataConnectMutationResult<DeleteEmployeeWithAccessData, DeleteEmployeeWithAccessVariables>;
...
export function useCreateMirrorOutbox(options?: useDataConnectMutationOptions<CreateMirrorOutboxData, FirebaseError, CreateMirrorOutboxVariables>): UseDataConnectMutationResult<CreateMirrorOutboxData, CreateMirrorOutboxVariables>;
export function useCreateMirrorOutbox(dc: DataConnect, options?: useDataConnectMutationOptions<CreateMirrorOutboxData, FirebaseError, CreateMirrorOutboxVariables>): UseDataConnectMutationResult<CreateMirrorOutboxData, CreateMirrorOutboxVariables>;

export function useUpdateMirrorOutbox(options?: useDataConnectMutationOptions<UpdateMirrorOutboxData, FirebaseError, UpdateMirrorOutboxVariables>): UseDataConnectMutationResult<UpdateMirrorOutboxData, UpdateMirrorOutboxVariables>;
export function useUpdateMirrorOutbox(dc: DataConnect, options?: useDataConnectMutationOptions<UpdateMirrorOutboxData, FirebaseError, UpdateMirrorOutboxVariables>): UseDataConnectMutationResult<UpdateMirrorOutboxData, UpdateMirrorOutboxVariables>;
...
export function useListLegacyAccessCodes(options?: useDataConnectQueryOptions<ListLegacyAccessCodesData>): UseDataConnectQueryResult<ListLegacyAccessCodesData, undefined>;
export function useListLegacyAccessCodes(dc: DataConnect, options?: useDataConnectQueryOptions<ListLegacyAccessCodesData>): UseDataConnectQueryResult<ListLegacyAccessCodesData, undefined>;
...
export function useGetBusinessById(vars: GetBusinessByIdVariables, options?: useDataConnectQueryOptions<GetBusinessByIdData>): UseDataConnectQueryResult<GetBusinessByIdData, GetBusinessByIdVariables>;
export function useGetBusinessById(dc: DataConnect, vars: GetBusinessByIdVariables, options?: useDataConnectQueryOptions<GetBusinessByIdData>): UseDataConnectQueryResult<GetBusinessByIdData, GetBusinessByIdVariables>;

export function useGetBusinessSettings(vars: GetBusinessSettingsVariables, options?: useDataConnectQueryOptions<GetBusinessSettingsData>): UseDataConnectQueryResult<GetBusinessSettingsData, GetBusinessSettingsVariables>;
export function useGetBusinessSettings(dc: DataConnect, vars: GetBusinessSettingsVariables, options?: useDataConnectQueryOptions<GetBusinessSettingsData>): UseDataConnectQueryResult<GetBusinessSettingsData, GetBusinessSettingsVariables>;

export function useGetBusinessByCode(vars: GetBusinessByCodeVariables, options?: useDataConnectQueryOptions<GetBusinessByCodeData>): UseDataConnectQueryResult<GetBusinessByCodeData, GetBusinessByCodeVariables>;
export function useGetBusinessByCode(dc: DataConnect, vars: GetBusinessByCodeVariables, options?: useDataConnectQueryOptions<GetBusinessByCodeData>): UseDataConnectQueryResult<GetBusinessByCodeData, GetBusinessByCodeVariables>;

export function useGetBusinessesByName(vars: GetBusinessesByNameVariables, options?: useDataConnectQueryOptions<GetBusinessesByNameData>): UseDataConnectQueryResult<GetBusinessesByNameData, GetBusinessesByNameVariables>;
export function useGetBusinessesByName(dc: DataConnect, vars: GetBusinessesByNameVariables, options?: useDataConnectQueryOptions<GetBusinessesByNameData>): UseDataConnectQueryResult<GetBusinessesByNameData, GetBusinessesByNameVariables>;

export function useVerifyEmployeeAccess(vars: VerifyEmployeeAccessVariables, options?: useDataConnectQueryOptions<VerifyEmployeeAccessData>): UseDataConnectQueryResult<VerifyEmployeeAccessData, VerifyEmployeeAccessVariables>;
export function useVerifyEmployeeAccess(dc: DataConnect, vars: VerifyEmployeeAccessVariables, options?: useDataConnectQueryOptions<VerifyEmployeeAccessData>): UseDataConnectQueryResult<VerifyEmployeeAccessData, VerifyEmployeeAccessVariables>;

export function useVerifyUserLogin(vars: VerifyUserLoginVariables, options?: useDataConnectQueryOptions<VerifyUserLoginData>): UseDataConnectQueryResult<VerifyUserLoginData, VerifyUserLoginVariables>;
export function useVerifyUserLogin(dc: DataConnect, vars: VerifyUserLoginVariables, options?: useDataConnectQueryOptions<VerifyUserLoginData>): UseDataConnectQueryResult<VerifyUserLoginData, VerifyUserLoginVariables>;
...
export function useGetCustomerForCompany(vars: GetCustomerForCompanyVariables, options?: useDataConnectQueryOptions<GetCustomerForCompanyData>): UseDataConnectQueryResult<GetCustomerForCompanyData, GetCustomerForCompanyVariables>;
export function useGetCustomerForCompany(dc: DataConnect, vars: GetCustomerForCompanyVariables, options?: useDataConnectQueryOptions<GetCustomerForCompanyData>): UseDataConnectQueryResult<GetCustomerForCompanyData, GetCustomerForCompanyVariables>;

export function useListSaleCustomersByBusiness(vars: ListSaleCustomersByBusinessVariables, options?: useDataConnectQueryOptions<ListSaleCustomersByBusinessData>): UseDataConnectQueryResult<ListSaleCustomersByBusinessData, ListSaleCustomersByBusinessVariables>;
export function useListSaleCustomersByBusiness(dc: DataConnect, vars: ListSaleCustomersByBusinessVariables, options?: useDataConnectQueryOptions<ListSaleCustomersByBusinessData>): UseDataConnectQueryResult<ListSaleCustomersByBusinessData, ListSaleCustomersByBusinessVariables>;

export function useListTaskAssigneesByBusiness(vars: ListTaskAssigneesByBusinessVariables, options?: useDataConnectQueryOptions<ListTaskAssigneesByBusinessData>): UseDataConnectQueryResult<ListTaskAssigneesByBusinessData, ListTaskAssigneesByBusinessVariables>;
export function useListTaskAssigneesByBusiness(dc: DataConnect, vars: ListTaskAssigneesByBusinessVariables, options?: useDataConnectQueryOptions<ListTaskAssigneesByBusinessData>): UseDataConnectQueryResult<ListTaskAssigneesByBusinessData, ListTaskAssigneesByBusinessVariables>;
...
export function useListTasksAssignedToUser(vars: ListTasksAssignedToUserVariables, options?: useDataConnectQueryOptions<ListTasksAssignedToUserData>): UseDataConnectQueryResult<ListTasksAssignedToUserData, ListTasksAssignedToUserVariables>;
export function useListTasksAssignedToUser(dc: DataConnect, vars: ListTasksAssignedToUserVariables, options?: useDataConnectQueryOptions<ListTasksAssignedToUserData>): UseDataConnectQueryResult<ListTasksAssignedToUserData, ListTasksAssignedToUserVariables>;
...
export function useListNotifications(vars: ListNotificationsVariables, options?: useDataConnectQueryOptions<ListNotificationsData>): UseDataConnectQueryResult<ListNotificationsData, ListNotificationsVariables>;
export function useListNotifications(dc: DataConnect, vars: ListNotificationsVariables, options?: useDataConnectQueryOptions<ListNotificationsData>): UseDataConnectQueryResult<ListNotificationsData, ListNotificationsVariables>;

export function useListPendingMirrorOutbox(options?: useDataConnectQueryOptions<ListPendingMirrorOutboxData>): UseDataConnectQueryResult<ListPendingMirrorOutboxData, undefined>;
export function useListPendingMirrorOutbox(dc: DataConnect, options?: useDataConnectQueryOptions<ListPendingMirrorOutboxData>): UseDataConnectQueryResult<ListPendingMirrorOutboxData, undefined>;
