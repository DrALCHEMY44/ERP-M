...
import { ShoppingCart, Receipt, Users, Briefcase, TrendingUp, Package, AlertCircle, Sparkles } from "lucide-react"
        ...
        <Card className="lg:col-span-4 border-accent/20 bg-accent/5">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm leading-relaxed text-foreground/80">
              ...
              Le département des ventes a complété <strong>85%</strong> des tâches assignées, mais Marie Claire a 2 tâches en retard.
            </p>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="lg:col-span-4">
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>Top products by stock level</CardDescription>
            </div>
        ...
        <Card className="lg:col-span-3">
          <CardHeader>
            ...
            <CardDescription>Audit trail for today</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {[
                { user: "Jean-Pierre", action: "recorded a new sale", time: "2 mins ago" },
                { user: "Marie Claire", action: "updated task status", time: "15 mins ago" },
                { user: "AI Assistant", action: "generated summary report", time: "1 hour ago" },
                { user: "System", action: "backup successful", time: "3 hours ago" },
              ].map((activity, i) => (
            ...
            <Button variant="link" size="sm" className="w-full mt-4 text-xs">View all logs</Button>
          </CardContent>
        </Card>
      </div>
    </div>
