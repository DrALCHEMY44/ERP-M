...
class DeleteBusinessVariablesBuilder {
  ...
  Deserializer<DeleteBusinessData> dataDeserializer = (dynamic json) =>
      DeleteBusinessData.fromJson(jsonDecode(json));
  Serializer<DeleteBusinessVariables> varsSerializer =
      (DeleteBusinessVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<DeleteBusinessData, DeleteBusinessVariables>>
  execute() {
    return ref().execute();
  }
...
class DeleteBusinessBusinessDelete {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteBusinessBusinessDelete otherTyped =
        other as DeleteBusinessBusinessDelete;
  ...
  DeleteBusinessBusinessDelete({required this.id});
}
...
class DeleteBusinessData {
  ...
  DeleteBusinessData.fromJson(dynamic json)
    : business_delete = json['business_delete'] == null
          ? null
          : DeleteBusinessBusinessDelete.fromJson(json['business_delete']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
  ...
  DeleteBusinessData({this.business_delete});
}
...
class DeleteBusinessVariables {
  ...
  DeleteBusinessVariables({required this.id});
}
