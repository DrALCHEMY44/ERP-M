...
class GetBusinessByCodeVariablesBuilder {
  ...
  Deserializer<GetBusinessByCodeData> dataDeserializer = (dynamic json) =>
      GetBusinessByCodeData.fromJson(jsonDecode(json));
  Serializer<GetBusinessByCodeVariables> varsSerializer =
      (GetBusinessByCodeVariables vars) => jsonEncode(vars.toJson());
  Future<QueryResult<GetBusinessByCodeData, GetBusinessByCodeVariables>>
...
class GetBusinessByCodeBusinesses {
  ...
  bool operator ==(Object other) {
    ...
    final GetBusinessByCodeBusinesses otherTyped =
        other as GetBusinessByCodeBusinesses;
  ...
  @override
  int get hashCode =>
      Object.hashAll([id.hashCode, tenantId.hashCode, name.hashCode]);
...
class GetBusinessByCodeData {
  ...
  GetBusinessByCodeData({required this.businesses});
}
...
class GetBusinessByCodeVariables {
  ...
  bool operator ==(Object other) {
    ...
    final GetBusinessByCodeVariables otherTyped =
        other as GetBusinessByCodeVariables;
  ...
  GetBusinessByCodeVariables({required this.code});
}
