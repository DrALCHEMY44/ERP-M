...
class ListBusinessesVariablesBuilder {
  ...
  Deserializer<ListBusinessesData> dataDeserializer = (dynamic json) =>
      ListBusinessesData.fromJson(jsonDecode(json));
  Serializer<ListBusinessesVariables> varsSerializer =
      (ListBusinessesVariables vars) => jsonEncode(vars.toJson());
  Future<QueryResult<ListBusinessesData, ListBusinessesVariables>> execute({
...
class ListBusinessesBusinesses {
  ...
  bool operator ==(Object other) {
    ...
    final ListBusinessesBusinesses otherTyped =
        other as ListBusinessesBusinesses;
  ...
  @override
  int get hashCode =>
      Object.hashAll([id.hashCode, name.hashCode, location.hashCode]);
...
class ListBusinessesData {
  ...
  ListBusinessesData({required this.businesses});
}
...
class ListBusinessesVariables {
  ...
  ListBusinessesVariables({required this.tenantId});
}
