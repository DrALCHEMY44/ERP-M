...
class CreateMirrorOutboxVariablesBuilder {
  ...
  CreateMirrorOutboxVariablesBuilder(
    this._dataConnect, {
  ...
  Deserializer<CreateMirrorOutboxData> dataDeserializer = (dynamic json) =>
      CreateMirrorOutboxData.fromJson(jsonDecode(json));
  Serializer<CreateMirrorOutboxVariables> varsSerializer =
      (CreateMirrorOutboxVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<CreateMirrorOutboxData, CreateMirrorOutboxVariables>>
  execute() {
    return ref().execute();
  }

  MutationRef<CreateMirrorOutboxData, CreateMirrorOutboxVariables> ref() {
    CreateMirrorOutboxVariables vars = CreateMirrorOutboxVariables(
      tenantId: tenantId,
...
class CreateMirrorOutboxMirrorOutboxInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateMirrorOutboxMirrorOutboxInsert otherTyped =
        other as CreateMirrorOutboxMirrorOutboxInsert;
  ...
  CreateMirrorOutboxMirrorOutboxInsert({required this.id});
}
...
class CreateMirrorOutboxData {
  ...
  CreateMirrorOutboxData.fromJson(dynamic json)
    : mirrorOutbox_insert = CreateMirrorOutboxMirrorOutboxInsert.fromJson(
        json['mirrorOutbox_insert'],
      );
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
  ...
  CreateMirrorOutboxData({required this.mirrorOutbox_insert});
}
...
class CreateMirrorOutboxVariables {
  ...
  bool operator ==(Object other) {
    ...
    final CreateMirrorOutboxVariables otherTyped =
        other as CreateMirrorOutboxVariables;
