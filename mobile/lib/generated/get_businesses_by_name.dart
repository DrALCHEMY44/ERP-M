...
class GetBusinessesByNameVariablesBuilder {
  ...
  Deserializer<GetBusinessesByNameData> dataDeserializer = (dynamic json) =>
      GetBusinessesByNameData.fromJson(jsonDecode(json));
  Serializer<GetBusinessesByNameVariables> varsSerializer =
      (GetBusinessesByNameVariables vars) => jsonEncode(vars.toJson());
  Future<QueryResult<GetBusinessesByNameData, GetBusinessesByNameVariables>>
  ...
  QueryRef<GetBusinessesByNameData, GetBusinessesByNameVariables> ref() {
    GetBusinessesByNameVariables vars = GetBusinessesByNameVariables(
      name: name,
    );
...
class GetBusinessesByNameBusinesses {
  ...
  bool operator ==(Object other) {
    ...
    final GetBusinessesByNameBusinesses otherTyped =
        other as GetBusinessesByNameBusinesses;
...
class GetBusinessesByNameData {
  ...
  GetBusinessesByNameData({required this.businesses});
}
...
class GetBusinessesByNameVariables {
  ...
  bool operator ==(Object other) {
    ...
    final GetBusinessesByNameVariables otherTyped =
        other as GetBusinessesByNameVariables;
  ...
  GetBusinessesByNameVariables({required this.name});
}
