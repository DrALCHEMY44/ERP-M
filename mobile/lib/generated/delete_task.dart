...
class DeleteTaskVariablesBuilder {
  ...
  Deserializer<DeleteTaskData> dataDeserializer = (dynamic json) =>
      DeleteTaskData.fromJson(jsonDecode(json));
  Serializer<DeleteTaskVariables> varsSerializer = (DeleteTaskVariables vars) =>
...
class DeleteTaskTaskDelete {
  ...
  DeleteTaskTaskDelete({required this.id});
}
...
class DeleteTaskData {
  ...
  DeleteTaskData.fromJson(dynamic json)
    : task_delete = json['task_delete'] == null
          ? null
          : DeleteTaskTaskDelete.fromJson(json['task_delete']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
  ...
  DeleteTaskData({this.task_delete});
}
...
class DeleteTaskVariables {
  ...
  DeleteTaskVariables({required this.id});
}
