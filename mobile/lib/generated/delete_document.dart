...
class DeleteDocumentVariablesBuilder {
  ...
  Deserializer<DeleteDocumentData> dataDeserializer = (dynamic json) =>
      DeleteDocumentData.fromJson(jsonDecode(json));
  Serializer<DeleteDocumentVariables> varsSerializer =
      (DeleteDocumentVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<DeleteDocumentData, DeleteDocumentVariables>>
  execute() {
    return ref().execute();
  }
...
class DeleteDocumentDocumentDelete {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteDocumentDocumentDelete otherTyped =
        other as DeleteDocumentDocumentDelete;
  ...
  DeleteDocumentDocumentDelete({required this.id});
}
...
class DeleteDocumentData {
  ...
  DeleteDocumentData.fromJson(dynamic json)
    : document_delete = json['document_delete'] == null
          ? null
          : DeleteDocumentDocumentDelete.fromJson(json['document_delete']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
  ...
  DeleteDocumentData({this.document_delete});
}
...
class DeleteDocumentVariables {
  ...
  DeleteDocumentVariables({required this.id});
}
