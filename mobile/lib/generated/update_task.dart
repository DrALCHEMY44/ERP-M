...
class UpdateTaskVariablesBuilder {
  ...
  Optional<TaskStatus> _status = Optional.optional(
    (data) => TaskStatus.values.byName(data),
    enumSerializer,
  );
  Optional<TaskPriority> _priority = Optional.optional(
    (data) => TaskPriority.values.byName(data),
    enumSerializer,
  );
  Optional<Timestamp> _dueDate = Optional.optional(
    (json) => json['dueDate'] = Timestamp.fromJson(json['dueDate']),
    defaultSerializer,
  );
  Optional<String> _assignedToId = Optional.optional(
    nativeFromJson,
    nativeToJson,
  );
  ...
  Deserializer<UpdateTaskData> dataDeserializer = (dynamic json) =>
      UpdateTaskData.fromJson(jsonDecode(json));
  Serializer<UpdateTaskVariables> varsSerializer = (UpdateTaskVariables vars) =>
  ...
  MutationRef<UpdateTaskData, UpdateTaskVariables> ref() {
    UpdateTaskVariables vars = UpdateTaskVariables(
      id: id,
      title: _title,
...
class UpdateTaskTaskUpdate {
  ...
  UpdateTaskTaskUpdate({required this.id});
}
...
class UpdateTaskData {
  ...
  UpdateTaskData.fromJson(dynamic json)
    : task_update = json['task_update'] == null
          ? null
          : UpdateTaskTaskUpdate.fromJson(json['task_update']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
  ...
  UpdateTaskData({this.task_update});
}
...
class UpdateTaskVariables {
  ...
  UpdateTaskVariables.fromJson(Map<String, dynamic> json)
    ...
    priority.value = json['priority'] == null
        ? null
        : TaskPriority.values.byName(json['priority']);

    dueDate = Optional.optional(
      (json) => json['dueDate'] = Timestamp.fromJson(json['dueDate']),
      defaultSerializer,
    );
    dueDate.value = json['dueDate'] == null
        ? null
        : Timestamp.fromJson(json['dueDate']);

    assignedToId = Optional.optional(nativeFromJson, nativeToJson);
    assignedToId.value = json['assignedToId'] == null
        ? null
        : nativeFromJson<String>(json['assignedToId']);
  }
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
