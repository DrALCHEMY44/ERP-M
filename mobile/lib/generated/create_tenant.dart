...
class CreateTenantVariablesBuilder {
  ...
  Deserializer<CreateTenantData> dataDeserializer = (dynamic json) =>
      CreateTenantData.fromJson(jsonDecode(json));
  Serializer<CreateTenantVariables> varsSerializer =
      (CreateTenantVariables vars) => jsonEncode(vars.toJson());
  ...
  MutationRef<CreateTenantData, CreateTenantVariables> ref() {
    CreateTenantVariables vars = CreateTenantVariables(
      name: name,
...
class CreateTenantTenantInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateTenantTenantInsert otherTyped =
        other as CreateTenantTenantInsert;
  ...
  CreateTenantTenantInsert({required this.id});
}
...
class CreateTenantData {
  ...
  CreateTenantData({required this.tenant_insert});
}
