...
class CreateActivityLogVariablesBuilder {
  ...
  CreateActivityLogVariablesBuilder(
    this._dataConnect, {
  ...
  Deserializer<CreateActivityLogData> dataDeserializer = (dynamic json) =>
      CreateActivityLogData.fromJson(jsonDecode(json));
  Serializer<CreateActivityLogVariables> varsSerializer =
      (CreateActivityLogVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<CreateActivityLogData, CreateActivityLogVariables>>
  execute() {
    return ref().execute();
  }

  MutationRef<CreateActivityLogData, CreateActivityLogVariables> ref() {
    CreateActivityLogVariables vars = CreateActivityLogVariables(
      tenantId: tenantId,
...
class CreateActivityLogActivityLogInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateActivityLogActivityLogInsert otherTyped =
        other as CreateActivityLogActivityLogInsert;
  ...
  CreateActivityLogActivityLogInsert({required this.id});
}
...
class CreateActivityLogData {
  ...
  CreateActivityLogData.fromJson(dynamic json)
    : activityLog_insert = CreateActivityLogActivityLogInsert.fromJson(
        json['activityLog_insert'],
      );
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
  ...
  CreateActivityLogData({required this.activityLog_insert});
}
...
class CreateActivityLogVariables {
  ...
  CreateActivityLogVariables.fromJson(Map<String, dynamic> json)
    ...
    recordId.value = json['recordId'] == null
        ? null
  ...
  bool operator ==(Object other) {
    ...
    final CreateActivityLogVariables otherTyped =
        other as CreateActivityLogVariables;
