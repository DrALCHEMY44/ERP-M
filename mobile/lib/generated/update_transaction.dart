...
class UpdateTransactionVariablesBuilder {
  ...
  Optional<TransactionType> _type = Optional.optional(
    (data) => TransactionType.values.byName(data),
    enumSerializer,
  );
  Optional<double> _amount = Optional.optional(nativeFromJson, nativeToJson);
  Optional<Timestamp> _date = Optional.optional(
    (json) => json['date'] = Timestamp.fromJson(json['date']),
    defaultSerializer,
  );
  ...
  Optional<String> _receiptUrl = Optional.optional(
    nativeFromJson,
    nativeToJson,
  );
  Optional<String> _recordedBy = Optional.optional(
    nativeFromJson,
    nativeToJson,
  );
  ...
  Deserializer<UpdateTransactionData> dataDeserializer = (dynamic json) =>
      UpdateTransactionData.fromJson(jsonDecode(json));
  Serializer<UpdateTransactionVariables> varsSerializer =
      (UpdateTransactionVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<UpdateTransactionData, UpdateTransactionVariables>>
  execute() {
    return ref().execute();
  }

  MutationRef<UpdateTransactionData, UpdateTransactionVariables> ref() {
    UpdateTransactionVariables vars = UpdateTransactionVariables(
      id: id,
      tenantId: _tenantId,
...
class UpdateTransactionTransactionUpdate {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateTransactionTransactionUpdate otherTyped =
        other as UpdateTransactionTransactionUpdate;
  ...
  UpdateTransactionTransactionUpdate({required this.id});
}
...
class UpdateTransactionData {
  ...
  UpdateTransactionData.fromJson(dynamic json)
    : transaction_update = json['transaction_update'] == null
          ? null
          : UpdateTransactionTransactionUpdate.fromJson(
              json['transaction_update'],
            );
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
  ...
  UpdateTransactionData({this.transaction_update});
}
...
class UpdateTransactionVariables {
  ...
  UpdateTransactionVariables.fromJson(Map<String, dynamic> json)
    ...
    type.value = json['type'] == null
        ? null
        : TransactionType.values.byName(json['type']);

    amount = Optional.optional(nativeFromJson, nativeToJson);
    amount.value = json['amount'] == null
        ? null
        : nativeFromJson<double>(json['amount']);
    ...
    category.value = json['category'] == null
        ? null
    ...
    receiptUrl.value = json['receiptUrl'] == null
        ? null
        : nativeFromJson<String>(json['receiptUrl']);

    recordedBy = Optional.optional(nativeFromJson, nativeToJson);
    recordedBy.value = json['recordedBy'] == null
        ? null
        : nativeFromJson<String>(json['recordedBy']);
  }
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
    ...
    final UpdateTransactionVariables otherTyped =
        other as UpdateTransactionVariables;
    return id == otherTyped.id &&
