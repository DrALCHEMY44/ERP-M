...
class UpdateTenantVariablesBuilder {
  ...
  Optional<String> _businessSector = Optional.optional(
    nativeFromJson,
    nativeToJson,
  );
  Optional<String> _location = Optional.optional(nativeFromJson, nativeToJson);
  Optional<String> _ownerEmail = Optional.optional(
    nativeFromJson,
    nativeToJson,
  );
  ...
  Optional<String> _subscriptionTier = Optional.optional(
    nativeFromJson,
    nativeToJson,
  );
  ...
  Deserializer<UpdateTenantData> dataDeserializer = (dynamic json) =>
      UpdateTenantData.fromJson(jsonDecode(json));
  Serializer<UpdateTenantVariables> varsSerializer =
      (UpdateTenantVariables vars) => jsonEncode(vars.toJson());
  ...
  MutationRef<UpdateTenantData, UpdateTenantVariables> ref() {
    UpdateTenantVariables vars = UpdateTenantVariables(
      id: id,
      name: _name,
...
class UpdateTenantTenantUpdate {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateTenantTenantUpdate otherTyped =
        other as UpdateTenantTenantUpdate;
  ...
  UpdateTenantTenantUpdate({required this.id});
}
...
class UpdateTenantData {
  ...
  UpdateTenantData.fromJson(dynamic json)
    : tenant_update = json['tenant_update'] == null
          ? null
          : UpdateTenantTenantUpdate.fromJson(json['tenant_update']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
  ...
  UpdateTenantData({this.tenant_update});
}
...
class UpdateTenantVariables {
  ...
  UpdateTenantVariables.fromJson(Map<String, dynamic> json)
    ...
    businessSector.value = json['businessSector'] == null
        ? null
        : nativeFromJson<String>(json['businessSector']);
    ...
    ownerEmail.value = json['ownerEmail'] == null
        ? null
        : nativeFromJson<String>(json['ownerEmail']);
    ...
    subscriptionTier.value = json['subscriptionTier'] == null
        ? null
        : nativeFromJson<String>(json['subscriptionTier']);
