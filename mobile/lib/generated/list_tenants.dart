...
class ListTenantsVariablesBuilder {
  ...
  Deserializer<ListTenantsData> dataDeserializer = (dynamic json) =>
      ListTenantsData.fromJson(jsonDecode(json));

  Future<QueryResult<ListTenantsData, void>> execute({
...
class ListTenantsData {
  ...
  ListTenantsData({required this.tenants});
}
