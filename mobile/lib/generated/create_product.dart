...
class CreateProductVariablesBuilder {
  ...
  Deserializer<CreateProductData> dataDeserializer = (dynamic json) =>
      CreateProductData.fromJson(jsonDecode(json));
  Serializer<CreateProductVariables> varsSerializer =
      (CreateProductVariables vars) => jsonEncode(vars.toJson());
  ...
  MutationRef<CreateProductData, CreateProductVariables> ref() {
    CreateProductVariables vars = CreateProductVariables(
      tenantId: tenantId,
...
class CreateProductProductInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateProductProductInsert otherTyped =
        other as CreateProductProductInsert;
  ...
  CreateProductProductInsert({required this.id});
}
...
class CreateProductData {
  ...
  CreateProductData.fromJson(dynamic json)
    : product_insert = CreateProductProductInsert.fromJson(
        json['product_insert'],
      );
  @override
  bool operator ==(Object other) {
  ...
  CreateProductData({required this.product_insert});
}
