...
class UpdateEmployeeVariablesBuilder {
  ...
  Deserializer<UpdateEmployeeData> dataDeserializer = (dynamic json) =>
      UpdateEmployeeData.fromJson(jsonDecode(json));
  Serializer<UpdateEmployeeVariables> varsSerializer =
      (UpdateEmployeeVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<UpdateEmployeeData, UpdateEmployeeVariables>>
  execute() {
    return ref().execute();
  }

  MutationRef<UpdateEmployeeData, UpdateEmployeeVariables> ref() {
    UpdateEmployeeVariables vars = UpdateEmployeeVariables(
      id: id,
      tenantId: _tenantId,
...
class UpdateEmployeeEmployeeUpdate {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateEmployeeEmployeeUpdate otherTyped =
        other as UpdateEmployeeEmployeeUpdate;
  ...
  UpdateEmployeeEmployeeUpdate({required this.id});
}
...
class UpdateEmployeeData {
  ...
  UpdateEmployeeData.fromJson(dynamic json)
    : employee_update = json['employee_update'] == null
          ? null
          : UpdateEmployeeEmployeeUpdate.fromJson(json['employee_update']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
  ...
  UpdateEmployeeData({this.employee_update});
}
...
class UpdateEmployeeVariables {
  ...
  UpdateEmployeeVariables.fromJson(Map<String, dynamic> json)
    ...
    fullName.value = json['fullName'] == null
        ? null
    ...
    position.value = json['position'] == null
        ? null
        : nativeFromJson<String>(json['position']);
