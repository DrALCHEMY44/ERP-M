...
class DeleteNotificationVariablesBuilder {
  ...
  Deserializer<DeleteNotificationData> dataDeserializer = (dynamic json) =>
      DeleteNotificationData.fromJson(jsonDecode(json));
  Serializer<DeleteNotificationVariables> varsSerializer =
      (DeleteNotificationVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<DeleteNotificationData, DeleteNotificationVariables>>
  execute() {
    return ref().execute();
  }
...
class DeleteNotificationNotificationDelete {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteNotificationNotificationDelete otherTyped =
        other as DeleteNotificationNotificationDelete;
  ...
  DeleteNotificationNotificationDelete({required this.id});
}
...
class DeleteNotificationData {
  ...
  DeleteNotificationData.fromJson(dynamic json)
    : notification_delete = json['notification_delete'] == null
          ? null
          : DeleteNotificationNotificationDelete.fromJson(
              json['notification_delete'],
            );
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
  ...
  DeleteNotificationData({this.notification_delete});
}
...
class DeleteNotificationVariables {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteNotificationVariables otherTyped =
        other as DeleteNotificationVariables;
    return id == otherTyped.id;
  }
  ...
  DeleteNotificationVariables({required this.id});
}
