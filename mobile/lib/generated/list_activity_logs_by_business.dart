...
class ListActivityLogsByBusinessVariablesBuilder {
  ...
  ListActivityLogsByBusinessVariablesBuilder(
    this._dataConnect, {
    required this.tenantId,
    required this.businessId,
  });
  Deserializer<ListActivityLogsByBusinessData> dataDeserializer =
      (dynamic json) =>
          ListActivityLogsByBusinessData.fromJson(jsonDecode(json));
  Serializer<ListActivityLogsByBusinessVariables> varsSerializer =
      (ListActivityLogsByBusinessVariables vars) => jsonEncode(vars.toJson());
  Future<
    QueryResult<
  ...
  QueryRef<ListActivityLogsByBusinessData, ListActivityLogsByBusinessVariables>
  ref() {
    ListActivityLogsByBusinessVariables vars =
        ListActivityLogsByBusinessVariables(
          tenantId: tenantId,
...
class ListActivityLogsByBusinessActivityLogs {
  ...
  bool operator ==(Object other) {
    ...
    final ListActivityLogsByBusinessActivityLogs otherTyped =
        other as ListActivityLogsByBusinessActivityLogs;
...
class ListActivityLogsByBusinessData {
  ...
  bool operator ==(Object other) {
    ...
    final ListActivityLogsByBusinessData otherTyped =
        other as ListActivityLogsByBusinessData;
  ...
  ListActivityLogsByBusinessData({required this.activityLogs});
}
...
class ListActivityLogsByBusinessVariables {
  ...
  bool operator ==(Object other) {
    ...
    final ListActivityLogsByBusinessVariables otherTyped =
        other as ListActivityLogsByBusinessVariables;
