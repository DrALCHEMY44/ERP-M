...
class CreateTaskVariablesBuilder {
  ...
  Deserializer<CreateTaskData> dataDeserializer = (dynamic json) =>
      CreateTaskData.fromJson(jsonDecode(json));
  Serializer<CreateTaskVariables> varsSerializer = (CreateTaskVariables vars) =>
  ...
  MutationRef<CreateTaskData, CreateTaskVariables> ref() {
    CreateTaskVariables vars = CreateTaskVariables(
      tenantId: tenantId,
...
class CreateTaskTaskInsert {
  ...
  CreateTaskTaskInsert({required this.id});
}
...
class CreateTaskData {
  ...
  CreateTaskData({required this.task_insert});
}
