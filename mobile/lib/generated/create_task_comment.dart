...
class CreateTaskCommentVariablesBuilder {
  ...
  CreateTaskCommentVariablesBuilder(
    this._dataConnect, {
  ...
  Deserializer<CreateTaskCommentData> dataDeserializer = (dynamic json) =>
      CreateTaskCommentData.fromJson(jsonDecode(json));
  Serializer<CreateTaskCommentVariables> varsSerializer =
      (CreateTaskCommentVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<CreateTaskCommentData, CreateTaskCommentVariables>>
  execute() {
    return ref().execute();
  }

  MutationRef<CreateTaskCommentData, CreateTaskCommentVariables> ref() {
    CreateTaskCommentVariables vars = CreateTaskCommentVariables(
      tenantId: tenantId,
...
class CreateTaskCommentTaskCommentInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateTaskCommentTaskCommentInsert otherTyped =
        other as CreateTaskCommentTaskCommentInsert;
  ...
  CreateTaskCommentTaskCommentInsert({required this.id});
}
...
class CreateTaskCommentData {
  ...
  CreateTaskCommentData.fromJson(dynamic json)
    : taskComment_insert = CreateTaskCommentTaskCommentInsert.fromJson(
        json['taskComment_insert'],
      );
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
  ...
  CreateTaskCommentData({required this.taskComment_insert});
}
...
class CreateTaskCommentVariables {
  ...
  bool operator ==(Object other) {
    ...
    final CreateTaskCommentVariables otherTyped =
        other as CreateTaskCommentVariables;
