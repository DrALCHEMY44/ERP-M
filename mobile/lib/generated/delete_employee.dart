...
class DeleteEmployeeVariablesBuilder {
  ...
  Deserializer<DeleteEmployeeData> dataDeserializer = (dynamic json) =>
      DeleteEmployeeData.fromJson(jsonDecode(json));
  Serializer<DeleteEmployeeVariables> varsSerializer =
      (DeleteEmployeeVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<DeleteEmployeeData, DeleteEmployeeVariables>>
  execute() {
    return ref().execute();
  }
...
class DeleteEmployeeEmployeeDelete {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteEmployeeEmployeeDelete otherTyped =
        other as DeleteEmployeeEmployeeDelete;
  ...
  DeleteEmployeeEmployeeDelete({required this.id});
}
...
class DeleteEmployeeData {
  ...
  DeleteEmployeeData.fromJson(dynamic json)
    : employee_delete = json['employee_delete'] == null
          ? null
          : DeleteEmployeeEmployeeDelete.fromJson(json['employee_delete']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
  ...
  DeleteEmployeeData({this.employee_delete});
}
...
class DeleteEmployeeVariables {
  ...
  DeleteEmployeeVariables({required this.id});
}
