...
class ListTransactionsByTypeVariablesBuilder {
  ...
  ListTransactionsByTypeVariablesBuilder(
    this._dataConnect, {
    required this.tenantId,
    required this.businessId,
    required this.type,
  });
  Deserializer<ListTransactionsByTypeData> dataDeserializer = (dynamic json) =>
      ListTransactionsByTypeData.fromJson(jsonDecode(json));
  Serializer<ListTransactionsByTypeVariables> varsSerializer =
      (ListTransactionsByTypeVariables vars) => jsonEncode(vars.toJson());
  Future<
    QueryResult<ListTransactionsByTypeData, ListTransactionsByTypeVariables>
  >
  ...
  QueryRef<ListTransactionsByTypeData, ListTransactionsByTypeVariables> ref() {
    ListTransactionsByTypeVariables vars = ListTransactionsByTypeVariables(
      tenantId: tenantId,
...
class ListTransactionsByTypeTransactions {
  ...
  bool operator ==(Object other) {
    ...
    final ListTransactionsByTypeTransactions otherTyped =
        other as ListTransactionsByTypeTransactions;
  ...
  Map<String, dynamic> toJson() {
    ...
    json['type'] = transactionTypeSerializer(type);
...
class ListTransactionsByTypeData {
  ...
  bool operator ==(Object other) {
    ...
    final ListTransactionsByTypeData otherTyped =
        other as ListTransactionsByTypeData;
  ...
  ListTransactionsByTypeData({required this.transactions});
}
...
class ListTransactionsByTypeVariables {
  ...
  bool operator ==(Object other) {
    ...
    final ListTransactionsByTypeVariables otherTyped =
        other as ListTransactionsByTypeVariables;
  ...
  @override
  int get hashCode =>
      Object.hashAll([tenantId.hashCode, businessId.hashCode, type.hashCode]);
