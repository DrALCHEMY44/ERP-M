...
class CreateCustomerVariablesBuilder {
  ...
  CreateCustomerVariablesBuilder(
    this._dataConnect, {
    required this.tenantId,
    required this.businessId,
    required this.customerName,
  });
  Deserializer<CreateCustomerData> dataDeserializer = (dynamic json) =>
      CreateCustomerData.fromJson(jsonDecode(json));
  Serializer<CreateCustomerVariables> varsSerializer =
      (CreateCustomerVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<CreateCustomerData, CreateCustomerVariables>>
  execute() {
    return ref().execute();
  }

  MutationRef<CreateCustomerData, CreateCustomerVariables> ref() {
    CreateCustomerVariables vars = CreateCustomerVariables(
      tenantId: tenantId,
...
class CreateCustomerCustomerInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateCustomerCustomerInsert otherTyped =
        other as CreateCustomerCustomerInsert;
  ...
  CreateCustomerCustomerInsert({required this.id});
}
...
class CreateCustomerData {
  ...
  CreateCustomerData.fromJson(dynamic json)
    : customer_insert = CreateCustomerCustomerInsert.fromJson(
        json['customer_insert'],
      );
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
  ...
  CreateCustomerData({required this.customer_insert});
}
