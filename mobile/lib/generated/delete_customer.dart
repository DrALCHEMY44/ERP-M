...
class DeleteCustomerVariablesBuilder {
  ...
  Deserializer<DeleteCustomerData> dataDeserializer = (dynamic json) =>
      DeleteCustomerData.fromJson(jsonDecode(json));
  Serializer<DeleteCustomerVariables> varsSerializer =
      (DeleteCustomerVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<DeleteCustomerData, DeleteCustomerVariables>>
  execute() {
    return ref().execute();
  }
...
class DeleteCustomerCustomerDelete {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteCustomerCustomerDelete otherTyped =
        other as DeleteCustomerCustomerDelete;
  ...
  DeleteCustomerCustomerDelete({required this.id});
}
...
class DeleteCustomerData {
  ...
  DeleteCustomerData.fromJson(dynamic json)
    : customer_delete = json['customer_delete'] == null
          ? null
          : DeleteCustomerCustomerDelete.fromJson(json['customer_delete']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
  ...
  DeleteCustomerData({this.customer_delete});
}
...
class DeleteCustomerVariables {
  ...
  DeleteCustomerVariables({required this.id});
}
