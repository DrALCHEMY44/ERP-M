...
class UpdateProductVariablesBuilder {
  ...
  Optional<double> _sellingPrice = Optional.optional(
    nativeFromJson,
    nativeToJson,
  );
  Optional<DateTime> _expiryDate = Optional.optional(
    nativeFromJson,
    nativeToJson,
  );
  Optional<int> _lowStockLevel = Optional.optional(
    nativeFromJson,
    nativeToJson,
  );
  ...
  Deserializer<UpdateProductData> dataDeserializer = (dynamic json) =>
      UpdateProductData.fromJson(jsonDecode(json));
  Serializer<UpdateProductVariables> varsSerializer =
      (UpdateProductVariables vars) => jsonEncode(vars.toJson());
  ...
  MutationRef<UpdateProductData, UpdateProductVariables> ref() {
    UpdateProductVariables vars = UpdateProductVariables(
      id: id,
      tenantId: _tenantId,
...
class UpdateProductProductUpdate {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateProductProductUpdate otherTyped =
        other as UpdateProductProductUpdate;
  ...
  UpdateProductProductUpdate({required this.id});
}
...
class UpdateProductData {
  ...
  UpdateProductData.fromJson(dynamic json)
    : product_update = json['product_update'] == null
          ? null
          : UpdateProductProductUpdate.fromJson(json['product_update']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
  ...
  UpdateProductData({this.product_update});
}
