...
class CreateNotificationVariablesBuilder {
  ...
  CreateNotificationVariablesBuilder(
    this._dataConnect, {
  ...
  Deserializer<CreateNotificationData> dataDeserializer = (dynamic json) =>
      CreateNotificationData.fromJson(jsonDecode(json));
  Serializer<CreateNotificationVariables> varsSerializer =
      (CreateNotificationVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<CreateNotificationData, CreateNotificationVariables>>
  execute() {
    return ref().execute();
  }

  MutationRef<CreateNotificationData, CreateNotificationVariables> ref() {
    CreateNotificationVariables vars = CreateNotificationVariables(
      tenantId: tenantId,
...
class CreateNotificationNotificationInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateNotificationNotificationInsert otherTyped =
        other as CreateNotificationNotificationInsert;
  ...
  CreateNotificationNotificationInsert({required this.id});
}
...
class CreateNotificationData {
  ...
  CreateNotificationData.fromJson(dynamic json)
    : notification_insert = CreateNotificationNotificationInsert.fromJson(
        json['notification_insert'],
      );
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
  ...
  CreateNotificationData({required this.notification_insert});
}
...
class CreateNotificationVariables {
  ...
  bool operator ==(Object other) {
    ...
    final CreateNotificationVariables otherTyped =
        other as CreateNotificationVariables;
