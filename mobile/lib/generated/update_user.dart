...
class UpdateUserVariablesBuilder {
  ...
  Optional<String> _accessCodeHash = Optional.optional(
    nativeFromJson,
    nativeToJson,
  );
  ...
  Serializer<UpdateUserVariables> varsSerializer = (UpdateUserVariables vars) =>
  ...
  MutationRef<UpdateUserData, UpdateUserVariables> ref() {
    UpdateUserVariables vars = UpdateUserVariables(
      id: id,
      tenantId: _tenantId,
...
class UpdateUserUserUpdate {
  ...
  UpdateUserUserUpdate({required this.id});
}
...
class UpdateUserData {
  ...
  UpdateUserData({this.user_update});
}
...
class UpdateUserVariables {
  ...
  UpdateUserVariables.fromJson(Map<String, dynamic> json)
    ...
    accessCodeHash.value = json['accessCodeHash'] == null
        ? null
