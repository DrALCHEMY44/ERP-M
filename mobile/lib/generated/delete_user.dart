...
class DeleteUserVariablesBuilder {
  ...
  Serializer<DeleteUserVariables> varsSerializer = (DeleteUserVariables vars) =>
...
class DeleteUserUserDelete {
  ...
  DeleteUserUserDelete({required this.id});
}
...
class DeleteUserData {
  ...
  DeleteUserData({this.user_delete});
}
...
class DeleteUserVariables {
  ...
  DeleteUserVariables({required this.id});
}
