...
class DeleteTaskCommentVariablesBuilder {
  ...
  Deserializer<DeleteTaskCommentData> dataDeserializer = (dynamic json) =>
      DeleteTaskCommentData.fromJson(jsonDecode(json));
  Serializer<DeleteTaskCommentVariables> varsSerializer =
      (DeleteTaskCommentVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<DeleteTaskCommentData, DeleteTaskCommentVariables>>
  execute() {
    return ref().execute();
  }
...
class DeleteTaskCommentTaskCommentDelete {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteTaskCommentTaskCommentDelete otherTyped =
        other as DeleteTaskCommentTaskCommentDelete;
  ...
  DeleteTaskCommentTaskCommentDelete({required this.id});
}
...
class DeleteTaskCommentData {
  ...
  DeleteTaskCommentData.fromJson(dynamic json)
    : taskComment_delete = json['taskComment_delete'] == null
          ? null
          : DeleteTaskCommentTaskCommentDelete.fromJson(
              json['taskComment_delete'],
            );
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
  ...
  DeleteTaskCommentData({this.taskComment_delete});
}
...
class DeleteTaskCommentVariables {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteTaskCommentVariables otherTyped =
        other as DeleteTaskCommentVariables;
    return id == otherTyped.id;
  }
  ...
  DeleteTaskCommentVariables({required this.id});
}
