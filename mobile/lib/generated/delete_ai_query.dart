...
class DeleteAiQueryVariablesBuilder {
  ...
  Deserializer<DeleteAiQueryData> dataDeserializer = (dynamic json) =>
      DeleteAiQueryData.fromJson(jsonDecode(json));
  Serializer<DeleteAiQueryVariables> varsSerializer =
      (DeleteAiQueryVariables vars) => jsonEncode(vars.toJson());
...
class DeleteAiQueryAiQueryDelete {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteAiQueryAiQueryDelete otherTyped =
        other as DeleteAiQueryAiQueryDelete;
  ...
  DeleteAiQueryAiQueryDelete({required this.id});
}
...
class DeleteAiQueryData {
  ...
  DeleteAiQueryData.fromJson(dynamic json)
    : aiQuery_delete = json['aiQuery_delete'] == null
          ? null
          : DeleteAiQueryAiQueryDelete.fromJson(json['aiQuery_delete']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
  ...
  DeleteAiQueryData({this.aiQuery_delete});
}
...
class DeleteAiQueryVariables {
  ...
  DeleteAiQueryVariables({required this.id});
}
