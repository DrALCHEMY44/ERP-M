...
class DeleteTenantVariablesBuilder {
  ...
  Deserializer<DeleteTenantData> dataDeserializer = (dynamic json) =>
      DeleteTenantData.fromJson(jsonDecode(json));
  Serializer<DeleteTenantVariables> varsSerializer =
      (DeleteTenantVariables vars) => jsonEncode(vars.toJson());
...
class DeleteTenantTenantDelete {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteTenantTenantDelete otherTyped =
        other as DeleteTenantTenantDelete;
  ...
  DeleteTenantTenantDelete({required this.id});
}
...
class DeleteTenantData {
  ...
  DeleteTenantData.fromJson(dynamic json)
    : tenant_delete = json['tenant_delete'] == null
          ? null
          : DeleteTenantTenantDelete.fromJson(json['tenant_delete']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
  ...
  DeleteTenantData({this.tenant_delete});
}
...
class DeleteTenantVariables {
  ...
  DeleteTenantVariables({required this.id});
}
