...
class CreateTransactionVariablesBuilder {
  ...
  CreateTransactionVariablesBuilder(
    this._dataConnect, {
  ...
  Deserializer<CreateTransactionData> dataDeserializer = (dynamic json) =>
      CreateTransactionData.fromJson(jsonDecode(json));
  Serializer<CreateTransactionVariables> varsSerializer =
      (CreateTransactionVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<CreateTransactionData, CreateTransactionVariables>>
  execute() {
    return ref().execute();
  }

  MutationRef<CreateTransactionData, CreateTransactionVariables> ref() {
    CreateTransactionVariables vars = CreateTransactionVariables(
      tenantId: tenantId,
...
class CreateTransactionTransactionInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateTransactionTransactionInsert otherTyped =
        other as CreateTransactionTransactionInsert;
  ...
  CreateTransactionTransactionInsert({required this.id});
}
...
class CreateTransactionData {
  ...
  CreateTransactionData.fromJson(dynamic json)
    : transaction_insert = CreateTransactionTransactionInsert.fromJson(
        json['transaction_insert'],
      );
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
  ...
  CreateTransactionData({required this.transaction_insert});
}
...
class CreateTransactionVariables {
  ...
  bool operator ==(Object other) {
    ...
    final CreateTransactionVariables otherTyped =
        other as CreateTransactionVariables;
