...
class DeleteTransactionVariablesBuilder {
  ...
  Deserializer<DeleteTransactionData> dataDeserializer = (dynamic json) =>
      DeleteTransactionData.fromJson(jsonDecode(json));
  Serializer<DeleteTransactionVariables> varsSerializer =
      (DeleteTransactionVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<DeleteTransactionData, DeleteTransactionVariables>>
  execute() {
    return ref().execute();
  }
...
class DeleteTransactionTransactionDelete {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteTransactionTransactionDelete otherTyped =
        other as DeleteTransactionTransactionDelete;
  ...
  DeleteTransactionTransactionDelete({required this.id});
}
...
class DeleteTransactionData {
  ...
  DeleteTransactionData.fromJson(dynamic json)
    : transaction_delete = json['transaction_delete'] == null
          ? null
          : DeleteTransactionTransactionDelete.fromJson(
              json['transaction_delete'],
            );
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
  ...
  DeleteTransactionData({this.transaction_delete});
}
...
class DeleteTransactionVariables {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteTransactionVariables otherTyped =
        other as DeleteTransactionVariables;
    return id == otherTyped.id;
  }
  ...
  DeleteTransactionVariables({required this.id});
}
