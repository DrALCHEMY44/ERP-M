...
class CreateBusinessVariablesBuilder {
  ...
  CreateBusinessVariablesBuilder(
    this._dataConnect, {
  ...
  Deserializer<CreateBusinessData> dataDeserializer = (dynamic json) =>
      CreateBusinessData.fromJson(jsonDecode(json));
  Serializer<CreateBusinessVariables> varsSerializer =
      (CreateBusinessVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<CreateBusinessData, CreateBusinessVariables>>
  execute() {
    return ref().execute();
  }

  MutationRef<CreateBusinessData, CreateBusinessVariables> ref() {
    CreateBusinessVariables vars = CreateBusinessVariables(
      tenantId: tenantId,
      name: name,
      location: location,
...
class CreateBusinessBusinessInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateBusinessBusinessInsert otherTyped =
        other as CreateBusinessBusinessInsert;
  ...
  CreateBusinessBusinessInsert({required this.id});
}
...
class CreateBusinessData {
  ...
  CreateBusinessData.fromJson(dynamic json)
    : business_insert = CreateBusinessBusinessInsert.fromJson(
  ...
  CreateBusinessData({required this.business_insert});
}
