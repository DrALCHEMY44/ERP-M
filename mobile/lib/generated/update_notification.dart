...
class UpdateNotificationVariablesBuilder {
  ...
  Deserializer<UpdateNotificationData> dataDeserializer = (dynamic json) =>
      UpdateNotificationData.fromJson(jsonDecode(json));
  Serializer<UpdateNotificationVariables> varsSerializer =
      (UpdateNotificationVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<UpdateNotificationData, UpdateNotificationVariables>>
  execute() {
    return ref().execute();
  }

  MutationRef<UpdateNotificationData, UpdateNotificationVariables> ref() {
    UpdateNotificationVariables vars = UpdateNotificationVariables(
      id: id,
      tenantId: _tenantId,
...
class UpdateNotificationNotificationUpdate {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateNotificationNotificationUpdate otherTyped =
        other as UpdateNotificationNotificationUpdate;
  ...
  UpdateNotificationNotificationUpdate({required this.id});
}
...
class UpdateNotificationData {
  ...
  UpdateNotificationData.fromJson(dynamic json)
    : notification_update = json['notification_update'] == null
          ? null
          : UpdateNotificationNotificationUpdate.fromJson(
  ...
  UpdateNotificationData({this.notification_update});
}
...
class UpdateNotificationVariables {
  ...
  UpdateNotificationVariables.fromJson(Map<String, dynamic> json)
    ...
    message.value = json['message'] == null
        ? null
        : nativeFromJson<String>(json['message']);

    isRead = Optional.optional(nativeFromJson, nativeToJson);
    isRead.value = json['isRead'] == null
        ? null
        : nativeFromJson<bool>(json['isRead']);
  }
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
    ...
    final UpdateNotificationVariables otherTyped =
        other as UpdateNotificationVariables;
    return id == otherTyped.id &&
