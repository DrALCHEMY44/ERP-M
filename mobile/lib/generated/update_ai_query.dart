...
class UpdateAiQueryVariablesBuilder {
  ...
  Deserializer<UpdateAiQueryData> dataDeserializer = (dynamic json) =>
      UpdateAiQueryData.fromJson(jsonDecode(json));
  Serializer<UpdateAiQueryVariables> varsSerializer =
      (UpdateAiQueryVariables vars) => jsonEncode(vars.toJson());
  ...
  MutationRef<UpdateAiQueryData, UpdateAiQueryVariables> ref() {
    UpdateAiQueryVariables vars = UpdateAiQueryVariables(
      id: id,
      tenantId: _tenantId,
...
class UpdateAiQueryAiQueryUpdate {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateAiQueryAiQueryUpdate otherTyped =
        other as UpdateAiQueryAiQueryUpdate;
  ...
  UpdateAiQueryAiQueryUpdate({required this.id});
}
...
class UpdateAiQueryData {
  ...
  UpdateAiQueryData.fromJson(dynamic json)
    : aiQuery_update = json['aiQuery_update'] == null
          ? null
          : UpdateAiQueryAiQueryUpdate.fromJson(json['aiQuery_update']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
  ...
  UpdateAiQueryData({this.aiQuery_update});
}
...
class UpdateAiQueryVariables {
  ...
  UpdateAiQueryVariables.fromJson(Map<String, dynamic> json)
    ...
    queryText.value = json['queryText'] == null
        ? null
        : nativeFromJson<String>(json['queryText']);

    response = Optional.optional(nativeFromJson, nativeToJson);
    response.value = json['response'] == null
        ? null
        : nativeFromJson<String>(json['response']);
  }
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
