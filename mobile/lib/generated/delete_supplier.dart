...
class DeleteSupplierVariablesBuilder {
  ...
  Deserializer<DeleteSupplierData> dataDeserializer = (dynamic json) =>
      DeleteSupplierData.fromJson(jsonDecode(json));
  Serializer<DeleteSupplierVariables> varsSerializer =
      (DeleteSupplierVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<DeleteSupplierData, DeleteSupplierVariables>>
  execute() {
    return ref().execute();
  }
...
class DeleteSupplierSupplierDelete {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteSupplierSupplierDelete otherTyped =
        other as DeleteSupplierSupplierDelete;
  ...
  DeleteSupplierSupplierDelete({required this.id});
}
...
class DeleteSupplierData {
  ...
  DeleteSupplierData.fromJson(dynamic json)
    : supplier_delete = json['supplier_delete'] == null
          ? null
          : DeleteSupplierSupplierDelete.fromJson(json['supplier_delete']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
  ...
  DeleteSupplierData({this.supplier_delete});
}
...
class DeleteSupplierVariables {
  ...
  DeleteSupplierVariables({required this.id});
}
