...
class UpdateCustomerVariablesBuilder {
  ...
  Optional<String> _customerName = Optional.optional(
    nativeFromJson,
    nativeToJson,
  );
  ...
  Deserializer<UpdateCustomerData> dataDeserializer = (dynamic json) =>
      UpdateCustomerData.fromJson(jsonDecode(json));
  Serializer<UpdateCustomerVariables> varsSerializer =
      (UpdateCustomerVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<UpdateCustomerData, UpdateCustomerVariables>>
  execute() {
    return ref().execute();
  }

  MutationRef<UpdateCustomerData, UpdateCustomerVariables> ref() {
    UpdateCustomerVariables vars = UpdateCustomerVariables(
      id: id,
      tenantId: _tenantId,
...
class UpdateCustomerCustomerUpdate {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateCustomerCustomerUpdate otherTyped =
        other as UpdateCustomerCustomerUpdate;
  ...
  UpdateCustomerCustomerUpdate({required this.id});
}
...
class UpdateCustomerData {
  ...
  UpdateCustomerData.fromJson(dynamic json)
    : customer_update = json['customer_update'] == null
          ? null
          : UpdateCustomerCustomerUpdate.fromJson(json['customer_update']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
  ...
  UpdateCustomerData({this.customer_update});
}
...
class UpdateCustomerVariables {
  ...
  UpdateCustomerVariables.fromJson(Map<String, dynamic> json)
    ...
    customerName.value = json['customerName'] == null
        ? null
        : nativeFromJson<String>(json['customerName']);
