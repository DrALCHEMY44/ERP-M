...
class CreateAiQueryVariablesBuilder {
  ...
  Deserializer<CreateAiQueryData> dataDeserializer = (dynamic json) =>
      CreateAiQueryData.fromJson(jsonDecode(json));
  Serializer<CreateAiQueryVariables> varsSerializer =
      (CreateAiQueryVariables vars) => jsonEncode(vars.toJson());
  ...
  MutationRef<CreateAiQueryData, CreateAiQueryVariables> ref() {
    CreateAiQueryVariables vars = CreateAiQueryVariables(
      tenantId: tenantId,
...
class CreateAiQueryAiQueryInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateAiQueryAiQueryInsert otherTyped =
        other as CreateAiQueryAiQueryInsert;
  ...
  CreateAiQueryAiQueryInsert({required this.id});
}
...
class CreateAiQueryData {
  ...
  CreateAiQueryData.fromJson(dynamic json)
    : aiQuery_insert = CreateAiQueryAiQueryInsert.fromJson(
        json['aiQuery_insert'],
      );
  @override
  bool operator ==(Object other) {
  ...
  CreateAiQueryData({required this.aiQuery_insert});
}
