...
class DeleteProductVariablesBuilder {
  ...
  Deserializer<DeleteProductData> dataDeserializer = (dynamic json) =>
      DeleteProductData.fromJson(jsonDecode(json));
  Serializer<DeleteProductVariables> varsSerializer =
      (DeleteProductVariables vars) => jsonEncode(vars.toJson());
...
class DeleteProductProductDelete {
  ...
  bool operator ==(Object other) {
    ...
    final DeleteProductProductDelete otherTyped =
        other as DeleteProductProductDelete;
  ...
  DeleteProductProductDelete({required this.id});
}
...
class DeleteProductData {
  ...
  DeleteProductData.fromJson(dynamic json)
    : product_delete = json['product_delete'] == null
          ? null
          : DeleteProductProductDelete.fromJson(json['product_delete']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
  ...
  DeleteProductData({this.product_delete});
}
...
class DeleteProductVariables {
  ...
  DeleteProductVariables({required this.id});
}
