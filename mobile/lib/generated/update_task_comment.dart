...
class UpdateTaskCommentVariablesBuilder {
  ...
  Deserializer<UpdateTaskCommentData> dataDeserializer = (dynamic json) =>
      UpdateTaskCommentData.fromJson(jsonDecode(json));
  Serializer<UpdateTaskCommentVariables> varsSerializer =
      (UpdateTaskCommentVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<UpdateTaskCommentData, UpdateTaskCommentVariables>>
  execute() {
    return ref().execute();
  }

  MutationRef<UpdateTaskCommentData, UpdateTaskCommentVariables> ref() {
    UpdateTaskCommentVariables vars = UpdateTaskCommentVariables(
      id: id,
      tenantId: _tenantId,
...
class UpdateTaskCommentTaskCommentUpdate {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateTaskCommentTaskCommentUpdate otherTyped =
        other as UpdateTaskCommentTaskCommentUpdate;
  ...
  UpdateTaskCommentTaskCommentUpdate({required this.id});
}
...
class UpdateTaskCommentData {
  ...
  UpdateTaskCommentData.fromJson(dynamic json)
    : taskComment_update = json['taskComment_update'] == null
          ? null
          : UpdateTaskCommentTaskCommentUpdate.fromJson(
              json['taskComment_update'],
            );
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
  ...
  UpdateTaskCommentData({this.taskComment_update});
}
...
class UpdateTaskCommentVariables {
  ...
  UpdateTaskCommentVariables.fromJson(Map<String, dynamic> json)
    ...
    taskId.value = json['taskId'] == null
        ? null
        : nativeFromJson<String>(json['taskId']);
    ...
    content.value = json['content'] == null
        ? null
  ...
  bool operator ==(Object other) {
    ...
    final UpdateTaskCommentVariables otherTyped =
        other as UpdateTaskCommentVariables;
    return id == otherTyped.id &&
