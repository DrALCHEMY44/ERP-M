...
class UpdateDocumentVariablesBuilder {
  ...
  Optional<String> _documentType = Optional.optional(
    nativeFromJson,
    nativeToJson,
  );
  ...
  Optional<String> _uploadedBy = Optional.optional(
    nativeFromJson,
    nativeToJson,
  );
  ...
  Deserializer<UpdateDocumentData> dataDeserializer = (dynamic json) =>
      UpdateDocumentData.fromJson(jsonDecode(json));
  Serializer<UpdateDocumentVariables> varsSerializer =
      (UpdateDocumentVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<UpdateDocumentData, UpdateDocumentVariables>>
  execute() {
    return ref().execute();
  }

  MutationRef<UpdateDocumentData, UpdateDocumentVariables> ref() {
    UpdateDocumentVariables vars = UpdateDocumentVariables(
      id: id,
      tenantId: _tenantId,
...
class UpdateDocumentDocumentUpdate {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateDocumentDocumentUpdate otherTyped =
        other as UpdateDocumentDocumentUpdate;
  ...
  UpdateDocumentDocumentUpdate({required this.id});
}
...
class UpdateDocumentData {
  ...
  UpdateDocumentData.fromJson(dynamic json)
    : document_update = json['document_update'] == null
          ? null
          : UpdateDocumentDocumentUpdate.fromJson(json['document_update']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
  ...
  UpdateDocumentData({this.document_update});
}
...
class UpdateDocumentVariables {
  ...
  UpdateDocumentVariables.fromJson(Map<String, dynamic> json)
    ...
    documentType.value = json['documentType'] == null
        ? null
        : nativeFromJson<String>(json['documentType']);

    fileUrl = Optional.optional(nativeFromJson, nativeToJson);
    fileUrl.value = json['fileUrl'] == null
        ? null
        : nativeFromJson<String>(json['fileUrl']);
    ...
    uploadedBy.value = json['uploadedBy'] == null
        ? null
        : nativeFromJson<String>(json['uploadedBy']);
  }
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
