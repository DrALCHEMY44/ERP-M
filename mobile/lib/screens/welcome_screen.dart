...
class _WelcomeScreenState extends State<WelcomeScreen> {
  ...
  static const _slides = [
    _WelcomeSlide(
      ...
      description:
          'Control sales, inventory, expenses and your team from one beautiful mobile workspace.',
    ...
    _WelcomeSlide(
      ...
      description:
          'Turn live company data and documents into clear answers, alerts and recommendations.',
    ...
    _WelcomeSlide(
      ...
      description:
          'Owners see the whole operation. Managers stay in control. Employees finish assigned work.',
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    slide.colors.first.withValues(alpha: .18),
                    const Color(0xFF0C1728),
                    slide.colors.last.withValues(alpha: .14),
                  ],
                ),
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: slide.colors.first.withValues(alpha: .09),
                      ),
                    ),
                  ),
                  Padding(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: slide.colors.last.withValues(alpha: .3),
                                blurRadius: 24,
                              ),
                            ],
                          ),
