...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  void _handleRegister() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        final authResult = await fb_auth.FirebaseAuth.instance
        ...
        if (fbUser != null) {
          await ApiService.request(
            ...
            method: 'POST',
            body: {
              'fullName': 'Owner of ${_businessNameController.text}',
              'businessName': _businessNameController.text.trim(),
              'businessSector': _selectedIndustry,
              'location': 'Cameroon',
              'region': 'Unspecified',
            },
          );
          ...
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(
                  'Registered "${_businessNameController.text}" securely.',
                ),
